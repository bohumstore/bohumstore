...
export const metadata: Metadata = {
  ...
  keywords:
    '보험, 보험비교, 보험상담, 맞춤형보험, 온라인보험, 보험가입, 보험추천, 연금보험, 변액연금보험, 확정형연금보험, 보증형연금보험, 8%연금보험, 7%연금보험, 고이율연금보험, 세제혜택연금보험, 단기납연금보험, 종신보험, 고환급종신보험, 저해지환급형종신보험, 간편가입종신보험, 단기납종신보험, 10년환급형종신보험, 15년환급형종신보험, 저축보험, 고이율저축보험, 세제혜택저축보험, 변액저축보험, 해약환급금, 환급률, 보험환급률, 납입기간, 납입완료보너스, 장기유지보너스, 암보험, 유사암보험, 고진단비암보험, 무해지암보험, 치매보험, 간병보험, 노후간병보험, 어린이보험, 태아보험, 자녀보험, 생명보험, 손해보험, 변액보험, 재테크보험, 노후대비보험, 절세보험',
  authors: [{ name: '보험스토어' }],
  creator: '보험스토어',
  publisher: '보험스토어',
  robots: {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://bohumstore.net/images/icons/kakao-og.png',
        width: 1000,
        height: 500,
  ...
  twitter: {
    ...
    title: '보험스토어 | Bohumstore',
    description: '연금보험, 종신보험, 저축보험 비교 및 상담',
    images: ['https://bohumstore.net/images/icons/kakao-og.png'],
  },
    ...
    <html lang="ko">
      <head>
        ...
        <meta
          ...
          content="0aw_ufWejmdoYnEGpMEUBAfWLjstUAWkkarWoRdjvMA"
        />
        {/* MS Windows 타일 설정 */}
        ...
        <noscript
          dangerouslySetInnerHTML={{
            __html:
              '<img src="//script.boraware.kr/protect_nbora.php?protect_id=j376" style="display:none;width:0;height:0;" border="0" />',
          }}
        />
