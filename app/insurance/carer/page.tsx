...
{/* 
            <div className="text-center mb-8">
              <h2 className="text-2xl md:text-3xl font-bold text-text-primary mb-4">간병인보험이 필요한 이유</h2>
              <p className="text-text-secondary mb-2">실비보험으로는 해결할 수 없는 간병비 부담을 덜어드립니다</p>
            </div>
*/}
            ...
            <div className="bg-pink-50 rounded-xl p-6 mb-8 border-2 border-pink-200">
              <div className="text-center mb-6">
                <h3 className="text-xl font-bold text-text-primary mb-2">🏥 간병인사용일당</h3>
                <p className="text-text-secondary mb-2">질병이나 상해 사고로 인하여 간병이 필요한 상황이 발생했을 때, 간병인을 먼저 고용하고 보험사에 청구하여 보상받는 보험입니다.</p>
              ...
              <div className="grid md:grid-cols-3 gap-4 mb-6">
                <div className="bg-white p-4 rounded-lg border-2 border-red-200">
                  <div className="text-center mb-3">
                    ...
                    <h4 className="font-bold text-status-red text-lg">가족간병</h4>
                  </div>
                  <div className="text-sm text-text-secondary">
                    <p className="mb-2">가족이 직접 간병하는 경우에도 보험금 지급</p>
                    <p className="text-xs text-text-muted">* 해당 내용은 보험사별, 상품별 상이할 수 있습니다.</p>
                  </div>
                </div>
                
                <div className="bg-white p-4 rounded-lg border-2 border-border-default">
                  <div className="text-center mb-3">
                    <div className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-2">
                      <span className="text-2xl">📋</span>
                    </div>
                    <h4 className="font-bold text-text-secondary text-lg">청구 방식</h4>
                  </div>
                  <div className="text-sm text-text-secondary">
                ...
                <div className="bg-white p-4 rounded-lg border-2 border-border-default">
                  <div className="text-center mb-3">
                    ...
                    <h4 className="font-bold text-text-secondary text-lg">보장내용</h4>
                  </div>
                  <div className="text-sm text-text-secondary">
                    <p className="mb-1">간병인사용일당<span className="text-xs">(요양병원제외)</span> <span className="font-semibold text-status-red">15~20만원</span></p>
            ...
            <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl p-6 md:p-8 mb-8 border border-orange-100">
              <div className="text-center mb-6">
                <h3 className="text-2xl font-bold text-text-primary mb-3">💝 소중한 가족을 위한 준비</h3>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="bg-white rounded-xl p-5 shadow-sm">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-10 h-10 bg-brand-primary-soft rounded-full flex items-center justify-center">
            ...
            {/* 이런 분에게 필요 */}
            <div className="text-center mb-6">
              <h3 className="text-xl font-bold text-text-primary mb-6">이런 분에게 간병인보험이 필요합니다</h3>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-bg-blue p-4 rounded-lg text-left">
                  <div className="font-semibold text-blue-700 mb-2">👥 맞벌이 가정</div>
                  <p className="text-sm text-text-secondary">직장 생활 중 가족 간병이 어려운 경우</p>
                  <p className="text-xs text-brand-primary mt-1">"일도 놓칠 수 없고, 가족도 돌봐야 하는 딜레마"</p>
                </div>
            ...
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-6 mb-8 border border-green-200">
              <div className="text-center mb-6">
                <h3 className="text-xl font-bold text-text-primary mb-3">💬 실제 고객 후기</h3>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white rounded-xl p-5 shadow-sm">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-12 h-12 bg-brand-primary-soft rounded-full flex items-center justify-center">
                      <span className="text-2xl">👩</span>
                    </div>
                    <div>
              ...
              <div className="text-center mt-6">
                <p className="text-xs text-text-muted">* 개인정보 보호를 위해 이름은 일부만 표기했습니다</p>
              </div>
            </div>
              ...
              <div className="text-center">
                ...
                <div className="bg-white rounded-xl p-4 mb-4 shadow-sm">
                  <p className="text-gray-800 leading-relaxed mb-2">
                    <span className="font-bold text-status-red">갑작스러운 간병 상황</span>은 언제든 찾아올 수 있습니다.
                  </p>
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
                  ...
                  <span className="text-sm text-text-secondary">간단한 정보 입력으로 맞춤 설계</span>
                </div>
              </div>
            </div>

            {/* FAQ 섹션 */}
            <div className="bg-page-bg rounded-xl p-6 mt-8">
              <h3 className="text-xl font-bold text-text-primary mb-6 text-center">자주 묻는 질문 (FAQ)</h3>
              <div className="space-y-4">
                <div className="bg-white p-4 rounded-lg">
                  <div className="font-semibold text-brand-primary mb-2">Q. 실비보험 있는데 꼭 필요해요?</div>
                  <p className="text-sm text-text-secondary">네. 실비보험은 의료비만 보장하고 간병비는 보장하지 않습니다. 간병인보험은 실비보험으로 해결할 수 없는 간병비를 별도로 보장합니다.</p>
                </div>
                <div className="bg-white p-4 rounded-lg">
                  <div className="font-semibold text-brand-primary mb-2">Q. 보험료 많이 비싸요?</div>
                  <p className="text-sm text-text-secondary">대부분 월 2~5만원 수준으로 가입 가능합니다. 하루 간병비 12만원에 비해 매우 경제적입니다.</p>
                </div>
                <div className="bg-white p-4 rounded-lg">
                  <div className="font-semibold text-brand-primary mb-2">Q. 기존 보험 있어도 상담 가능해요?</div>
                  <p className="text-sm text-text-secondary">네. 기존 보험과의 중복·부족 여부를 무료로 점검해드리고, 최적의 보장 설계를 도와드립니다.</p>
                </div>
                <div className="bg-white p-4 rounded-lg">
                  <div className="font-semibold text-brand-primary mb-2">Q. 가족이 간병해도 보험금 받나요?</div>
                  <p className="text-sm text-text-secondary">간병비보험의 경우 가족간병시에도 보험금을 지급합니다. 다만 보험사별로 약관이 다르니 상담 시 확인해드립니다.</p>
                </div>
                <div className="bg-white p-4 rounded-lg">
                  <div className="font-semibold text-brand-primary mb-2">Q. 치매보험과 간병보험의 차이점은?</div>
                  <p className="text-sm text-text-secondary">치매보험은 치매 진단 시 진단비를 지급하고, 간병보험은 실제 간병서비스 이용 시 간병비를 지급합니다. 두 보험 모두 상호 보완적 역할을 합니다.</p>
                </div>
                <div className="bg-white p-4 rounded-lg">
                  <div className="font-semibold text-brand-primary mb-2">Q. 장기요양등급 판정 전에도 보장받나요?</div>
                  <p className="text-sm text-text-secondary">네. 간병보험은 장기요양등급 판정과 관계없이 의사의 간병 필요 소견서만으로도 보험금을 받을 수 있습니다.</p>
                </div>
              </div>
            </div>
          </div>
