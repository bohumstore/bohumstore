  ...
  return (
    <div className="space-y-8 px-2 sm:px-4 md:px-8 py-4 md:py-6">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
          <div className="space-y-3 text-sm text-gray-700">
            <div>보험계약에 관한 불편사항 및 분쟁(민원)이 있을 경우, 먼저 우리회사 홈페이지(www.ibki.co.kr)에 신청하시거나, 당사 콜센터 (1577-4117, 1644-4117)로 연락 주시면 성심껏 상담하여 드리겠습니다. 또한 보험계약 유지 과정상 분쟁조정이 필요한 사항이 발생하거나 불만이 있을 경우에는 보험감독원 금융민원센터(국번없이 1322, 이동전화 : 지역 번호-1322)나 생명보험협회( 02)2262-6565)를 통해 상담을 받거나 분쟁 조정 등을 신청할 수있습니다.</div>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
          <div className="space-y-3 text-sm text-gray-700">
            ...
            <div>※ 보험상품 및 가격공시실 : www.ibki.co.kr (IBK연금보험㈜ 홈페이지)</div>
            <div>※ 보험상품 비교 공시 : www.klia.or.kr (생명보험협회)</div>
          </div>
        </div>
      </div>
