    ...
    <div className="space-y-8 px-2 sm:px-4 md:px-8 py-4 md:py-6">
      ...
      <div className="space-y-4">
        ...
        <div className="product-info-box">
          <p className="product-text">일반금융소비자는 회사등으로부터 충분한 설명을 받을 권리가 있으며, 그 설명을 이해한 후 거래할 것을 권고합니다.</p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="product-info-box">
          <div className="space-y-3 product-text">
            <div className="text-status-red">● 이 상품은 실적 배당형 상품으로 운용결과에 따라 납입원금의 손실이 발생 할 수 있으며, 그 손실은 가입자에게 귀속됩니다.</div>
            <div className="text-status-red">● 과거운용실적 또는 투자수익률 가정에 따른 해약환급금, 보험금 예시가 미래의 수익을 보장하는 것은 아닙니다.</div>
            <div className="text-status-red">● 납입한 보험료 중 사업비(계약체결비용 및 계약관리비용)를 차감한 금액만 특별계정에서 운용됩니다.</div>
            <div className="text-status-red">● 이 보험계약은 예금자보호법에 따라 보호되지 않습니다. 다만, 약관에서 보험회사가 최저보증하는 보험금(보증형인 경우 : 최저사망계약자적립액 및 실적 배당 종신연금 / 미보증형인 경우 : 최저사망계약자적립액) 및 특약에 한하여 예금자보호법에 따라 보호됩니다. 보호 한도는 해약환급금(또는 만기 시 보험금)에 기타지급금을 합하여 1인당 "5천만원까지"(본 보험회사의 여타 보호상품과 합산)이며, 이와 별도로 본 보험회사 보호상품의 사고보험금을 합산하여 1인당 "5천만원까지" 입니다. (단, 보험계약자 및 보험료납부자가 법인인 경우에는 보호되지 않습니다.)</div>
            <div className="text-status-red">(※단, 2025년 9월 1일부터 해당 보호 한도가 1억원으로 상향됩니다.)</div>
      ...
      <div className="space-y-4">
        ...
        <div className="product-info-box">
          <div className="space-y-3 product-text">
            <div className="text-status-red">● 은행의 예금·적금과 다릅니다. 이 보험계약은 납입보험료에 보험회사가 경비로 사용하는 사업비가 포함되어 있는 보험상품으로 은행의 연금신탁 또는 예금, 적금과 다릅니다.</div>
      ...
      <div className="space-y-4">
        ...
        <div className="product-info-box">
          <div className="space-y-3 product-text">
            <div className="text-status-red">● 해약환급금이 납입보험료보다 적은 이유는 다음과 같습니다. 납입한 보험료 중 사업비를 차감한 후 운영 · 적립되고 해지 시에는 계약자 적립액에서 이미 지출한 사업비 해당액을 차감하는 경우가 있기 때문입니다.</div>
