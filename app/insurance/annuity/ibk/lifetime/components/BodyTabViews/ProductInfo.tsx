    ...
    <div className="space-y-6 px-2 py-3 sm:px-4 md:px-8 md:py-4">
      ...
      <div className="space-y-4">
        ...
        <div className="product-info-box">
          <div className="space-y-4">
            <p className="text-sm">
              펀드운용 성과에 상관없이 최대 20년동안 연단리 8%로 부리된 연금액 보증
            </p>
      ...
      <div className="space-y-4">
        ...
        <div className="product-info-box">
          <div className="space-y-4">
            ...
            <div className="text-sm text-status-red">
              ※ 피보험자가 만 15세 이전에 사망한 경우의 최저사망적립액은 기납입 보험료
            </div>
            <div className="overflow-x-auto">
              <table className="product-table">
                <thead>
        ...
        <div className="product-info-box">
          <div className="space-y-4">
            <div>
              ...
              <div className="space-y-2 text-sm">
                <div>
                  <strong>납입한도:</strong> (해당월까지 납입한 기본보험료+선납보험료) × 200% - 이미
                  납입한 추가납입보험료의 합계 + 중도인출금액의 합계
                </div>
                ...
                <div className="text-status-red">
                  ※ 연간납입한도: 연간(보험연도 기준) 납입한 기본보험료의 2배까지만 가능(12개월치의
                  2배)
                </div>
              </div>
            </div>
            <div>
              ...
              <div className="space-y-2 text-sm">
                <div>
                  <strong>기본사항:</strong> 보험년도 기준 연 12회 인출가능, 계약월 이후 1개월이
                  지난 후부터 인출 가능
                </div>
                <div>
                  <strong>인출수수료:</strong> 없음
                </div>
                <div>
                  <strong>인출후 최소 계약자적립액:</strong> Max (기본보험료의 2배, 500만원)
                </div>
                <div className="text-status-red">
                  ※ 1회당 인출할 수 있는 최고한도는 인출 당시 해약환급금의 60%를 초과할 수 없습니다.
                </div>
                <div className="text-status-red">
                  ※ "인출신청일 + 제2영업일"에 "인출신청일 + 제2영업일"의 기준가를 적용하여
                  지급합니다.
                </div>
              </div>
            </div>
      ...
      <div className="space-y-4">
        ...
        <div className="product-info-box">
          <div className="space-y-4">
            <div className="space-y-2 text-sm">
              <div>
                <strong>가입연령:</strong> 0세부터 68세까지 누구나 조건없이 무심사 가입 가능
              </div>
            ...
            <div className="space-y-2 text-sm">
              <div>
                <strong>연금개시:</strong> 연금개시요건 충족 시 30세부터 연금개시 가능
              </div>
