            ...
            <div className="overflow-x-auto">
              <table className="product-table">
                ...
                <tbody className="text-text-primary">
                  <tr>
                    <td className="product-table-td font-semibold bg-page-bg">최저연금기준금액비율</td>
                    <td className="product-table-td">기납입 보험료 연단리 X% 부리</td>
                  </tr>
                </tbody>
              </table>
            </div>
            <div className="text-sm text-status-red">※ 해당보험료 납입일을 기준으로 일자 계산합니다.</div>
          </div>
        </div>
      </div>
          ...
          <div className="space-y-4">
            <div className="overflow-x-auto">
              <table className="product-table">
                ...
                <tbody className="text-text-primary">
                  <tr>
                    <td className="product-table-td font-semibold bg-page-bg">10년 이내</td>
                    <td className="product-table-td">최저연금기준금액의 3.60% (매월 0.30%)</td>
                  </tr>
                  <tr>
                    <td className="product-table-td font-semibold bg-page-bg">10년 이후</td>
                    <td className="product-table-td">최저연금기준금액의 1.80% (매월 0.15%)</td>
                  </tr>
                  <tr>
                    <td className="product-table-td font-semibold bg-page-bg">연금개시 이후</td>
      ...
      <div className="space-y-4">
        ...
        <div className="product-info-box">
          <div className="space-y-4">
            ...
            <div className="text-sm text-status-red">※ 피보험자가 만 15세 이전에 사망한 경우의 최저사망적립액은 기납입 보험료</div>
            <div className="overflow-x-auto">
              <table className="product-table">
                <thead>
                  <tr className="product-table-header">
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="text-status-red">※ 단, 연간 납입한도 존재</div>
                <div><strong>해당기간:</strong></div>
                <div>• 1형(보증형): 보험계약 성립 후부터 납입기간 종료일까지</div>
                <div>• 2형(미보증형): 보험계약 성립 후부터 연금개시일 전일까지</div>
                <div className="text-status-red">※ 연간납입한도: 연간(보험연도 기준) 납입한 기본보험료의 2배까지만 가능(12개월치의 2배)</div>
              </div>
            </div>
            <div>
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="text-status-red">※ 1회당 인출할 수 있는 최고한도는 인출 당시 해약환급금의 60%를 초과할 수 없습니다.</div>
                <div className="text-status-red">※ "인출신청일 + 제2영업일"에 "인출신청일 + 제2영업일"의 기준가를 적용하여 지급합니다.</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="product-info-box">
          <div className="space-y-4">
            <div className="space-y-2 text-sm">
              ...
              <div className="text-status-red">※ 유병력자(당뇨, 암, 고혈압 등)도 가입제한 없음</div>
              <div>• 청약서의 계약전 알릴 의무사항 작성 불필요</div>
            </div>
            <div className="space-y-2 text-sm">
              <div><strong>연금개시:</strong> 연금개시요건 충족 시 30세부터 연금개시 가능</div>
              <div className="text-status-red">※ 미보증형은 45세부터 연금개시 가능</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="product-info-box">
          <div className="space-y-4">
            ...
            <table className="w-full border-collapse text-xs sm:text-sm">
              ...
              <tbody className="text-text-primary">
                <tr>
                    <td className="product-table-td font-semibold bg-page-bg">보험종류</td>
                    <td className="product-table-td">변액연금보험</td>
                </tr>
                <tr>
                    <td className="product-table-td font-semibold bg-page-bg">부가가능 특약</td>
                    <td className="product-table-td">해당 없음</td>
                </tr>
                <tr>
                    <td className="product-table-td font-semibold bg-page-bg">가입나이</td>
                    <td className="product-table-td">0세~최대68세(미보증형: 최대75세)</td>
                </tr>
                <tr>
                    <td className="product-table-td font-semibold bg-page-bg">연금개시나이</td>
                    <td className="product-table-td">30세~80세(미보증형: 45~80세)</td>
                </tr>
                <tr>
                    <td className="product-table-td font-semibold bg-page-bg">납입기간</td>
                    <td className="product-table-td">5,7,10년납이상 (30년이하)</td>
                </tr>
                <tr>
                    <td className="product-table-td font-semibold bg-page-bg">납입주기</td>
                    <td className="product-table-td">월납</td>
                </tr>
                <tr>
                    <td className="product-table-td font-semibold bg-page-bg">최소거치기간</td>
                    <td className="product-table-td">5년납은 7년 / 7년납이상은 5년(미보증형: 없음)</td>
                </tr>
                <tr>
                    <td className="product-table-td font-semibold bg-page-bg">최소보험료</td>
                    <td className="product-table-td">5/7년납은 30만원이상, 10년납이상은 20만원이상</td>
                </tr>
              </tbody>
            </table>
            </div>
