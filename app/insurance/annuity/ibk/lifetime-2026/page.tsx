    ...
    <>
      ...
      >
        ...
        <div className="w-full flex justify-center bg-white">
          <div className="w-full max-w-3xl md:max-w-4xl lg:max-w-5xl mb-4 md:mb-6 lg:mb-8 mt-4 md:mt-6 lg:mt-8 px-4 sm:px-6 md:px-10 lg:px-16 py-0 text-xs sm:text-sm md:text-base text-gray-800">
            <div className="mb-2 font-bold text-sm sm:text-base md:text-lg">[ 유의사항 ]</div>
        ...
        {/* 구분선 */}
        <div className="w-full flex justify-center bg-white">
          <div className="w-full max-w-3xl md:max-w-4xl lg:max-w-5xl px-4 sm:px-6 md:px-10 lg:px-16">
            <hr className="border-gray-300 my-3 sm:my-4 md:my-5" />
          </div>
        </div>
        {/* 필수안내사항 박스 */}
        <div className="w-full flex justify-center bg-white pb-6 sm:pb-8 md:pb-10">
          <div className="w-full max-w-3xl md:max-w-4xl lg:max-w-5xl px-4 sm:px-6 md:px-10 lg:px-16 py-0 text-xs sm:text-sm md:text-base text-gray-800">
            <div className="mb-2 font-bold text-sm sm:text-base md:text-lg">[ 필수안내사항 ]</div>
            <div className="space-y-1 sm:space-y-1.5">
              <div>※ 본 광고는 심의기준을 준수하였으며, 유효기간은 심의일로부터 1년입니다.</div>
              <div className="text-red-500">※ 본계약은 기존 보험계약을 해지하고 새로운 보험계약을 체결하는 과정에서</div>
              <div className="text-red-500 pl-3 sm:pl-4">① 진행이력, 연령등에 따라 가입이 거절되거나 보험료가 인상될 수 있습니다.</div>
              <div className="text-red-500 pl-3 sm:pl-4">② 가입 상품에 따라 새로운 면책기간 적용 및 보장 제한 등 기타 불이익이 발생할 수 있습니다.</div>
              <div>※ 준법감시 심의필 000000000호 (0000.00.00~0000.00.00)</div>
            </div>
          </div>
        </div>
        <Footer />
