    ...
    <ProductInfoBodyTabTemplate title="가입안내">
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="product-info-box !bg-red-50/30">
            <div className="space-y-2 text-status-red">
              <div className="font-bold">[보험료 추가납입제도 안내]</div>
              <p>
        ...
        <div className="product-info-box">
          <div className="space-y-4">
            ...
            <div className="space-y-1.5 text-xs sm:space-y-2 sm:text-sm">
              <p>
                단, &ldquo;트리플 레벨업 보증시점&rdquo; 마다 각 시점까지 납입하기로 약정한 기본보험료 납입이
                완료되지 않은 경우, &ldquo;트리플 레벨업 보증시점&rdquo;은 해당 기본보험료의 납입이 완료된 날로
                하며, &ldquo;트리플 레벨업 보증 기준금액&rdquo;은 해당 기본보험료의 납입이 완료된 날까지의 &ldquo;기준
                기본보험료&rdquo;를 말합니다.
              </p>
              <p className="text-status-red">
