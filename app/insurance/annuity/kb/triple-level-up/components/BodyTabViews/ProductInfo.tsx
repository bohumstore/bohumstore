    ...
    <div className="space-y-8 px-2 sm:px-4 md:px-8 py-4 md:py-6">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-page-bg p-6 rounded-lg border border-border-default">
          <div className="space-y-4">
            <div className="flex flex-col md:flex-row md:items-center border-b border-border-default pb-4 ">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-page-bg p-6 rounded-lg border border-border-default">
          <div className="space-y-6">
            <div className="flex flex-col md:flex-row border-b border-border-default pb-4 ">
      ...
      <div className="space-y-4">
        ...
        <p className="product-caption">※ 최소거치기간 : 보험료 납입완료후 연금지급개시시점까지의 최소기간</p>
      </div>
      ...
      <div className="space-y-6">
        ...
        {/* 기본보험료 */}
        <div className="space-y-4">
          <h4 className="product-sub-title border-b border-product-primary pb-2 text-product-primary">기본보험료</h4>
          <table className="product-table text-xs md:text-sm">
            <thead>
              <tr className="product-table-header">
                <th className="product-table-th">보험료납입기간</th>
            ...
            <tbody className="product-table-body">
              <tr className="">
                ...
                <td className="product-table-td-center" rowSpan={3}>100만원</td>
              </tr>
              <tr className="">
                <td className="product-table-td-center">7년납</td>
                <td className="product-table-td-center">0세 ~ 70세</td>
          ...
          <p className="product-caption">※ 구좌란 보험금과 보장내용 등을 관리하기 위한 계약의 단위를 의미하며, 구좌당 최소ㆍ최대 보험료 등은 보험 상품마다 차이가 있으므로 자세한 내용은 약관을 참고해 주시길 바랍니다.</p>
        </div>

        {/* 추가납입보험료 */}
        <div className="space-y-4">
          <h4 className="product-sub-title border-b border-product-primary pb-2 text-product-primary">추가납입보험료</h4>
        ...
        {/* 중도인출에 관한 사항 */}
        <div className="space-y-4">
          <h4 className="product-sub-title border-b border-product-primary pb-2 text-product-primary">중도인출에 관한 사항</h4>
          <div className="product-info-box space-y-4">
            ...
            <p>(7) 계약자적립액을 인출한 경우 '이미 납입한 보험료'와 '기준 기본보험료'가 재계산되므로, <span className="text-status-red">인출금액보다 트리플 레벨업 보증이 현저하게 감소할 수 있습니다.</span></p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-page-bg p-3 sm:p-6 rounded-lg border border-border-default">
          ...
          <div className="bg-bg-blue p-3 sm:p-6 rounded-lg">
            <div className="text-center font-bold mb-3 sm:mb-4 text-product-primary text-sm sm:text-base leading-tight sm:leading-normal">트리플 레벨업 보증금액 = 트리플 레벨업 보증 기준금액 X 트리플 레벨업 보증비율</div>
              <table className="product-table text-xs sm:text-sm md:text-base">
                <thead>
                  <tr className="product-table-header">
                    <th className="product-table-th leading-tight w-[22%] sm:w-[20%]">트리플 레벨업<br />보증시점</th>
                    <th className="product-table-th leading-tight w-[23%] sm:w-[25%]">트리플 레벨업<br />보증 기준금액</th>
                    <th className="product-table-th" colSpan={3}>트리플 레벨업 보증비율</th>
                  </tr>
                  <tr className="product-table-header">
                ...
                <tbody>
                  <tr>
                    <td className="product-table-td leading-tight">계약일부터 7년<br />경과시점의 연계약해당일</td>
                    <td className="product-table-td-center leading-tight" rowSpan={2}>보증시점 전일까지의<br />"기준 기본보험료"</td>
                    <td className="product-table-td-center font-bold">100%</td>
                    <td className="product-table-td-center font-bold">100%</td>
                    <td className="product-table-td-center font-bold">100%</td>
                  </tr>
                  <tr>
                    <td className="product-table-td leading-tight">계약일부터 10년<br />경과시점의 연계약해당일</td>
      ...
      <div className="space-y-4">
        <h3 className="product-section-title">연금지급개시시점의 연금계약 계약자적립액에 관한 사항</h3>
        <div className="bg-page-bg p-3 sm:p-6 rounded-lg border border-border-default space-y-3 sm:space-y-4">
