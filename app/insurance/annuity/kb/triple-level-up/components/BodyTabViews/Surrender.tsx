        ...
        <div className="product-info-box">
          <div className="space-y-4">
            ...
            <div className="overflow-x-auto">
              <table className="product-table min-w-[700px] text-center text-xs md:text-sm">
                <thead>
                ...
                <tbody className="text-text-primary">
                  ...
                  <tr className="bg-red-50">
                    ...
                    <td className="product-table-td-center">3,000</td>
                    <td className="product-table-td-center">3,900</td>
                    <td className="product-table-td-center">130.0%</td>
                    <td className="product-table-td-center">3,900</td>
                    <td className="product-table-td-center">130.0%</td>
                    <td className="product-table-td-center">3,900</td>
                    <td className="product-table-td-center">130.0%</td>
            ...
            <ol className="list-decimal space-y-1 pl-4 text-xs text-text-secondary md:text-sm">
              <li>
