...
export default function Slogan({ onOpenPrivacy, onModalStateChange }: SloganProps) {
  ...
  // ── 상품별 설정 ──
  const [consultType, setConsultType] = React.useState('연금보험');
  ...
  const otpConfig = {
    ...
    companyName: productConfig?.config.companyName || 'KB라이프',
    productName: productConfig?.config.name || 'KB트리플레벨업연금보험',
    phone,
  };
  ...
  return (
    <>
      <section
        className="w-full bg-[#ffe15a] py-6 md:py-6 lg:flex lg:min-h-[600px] lg:items-center lg:py-3"
        style={{
      ...
      >
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-center gap-4 px-4 md:flex-col md:items-center md:gap-8 md:px-6 md:py-4 lg:flex-row lg:items-start lg:justify-between lg:gap-12 lg:px-4 lg:py-4">
          <div className="flex flex-1 flex-col items-center text-center md:items-center md:text-center lg:items-start lg:text-left">
            ...
            <h1 className="mb-3 text-2xl font-bold leading-tight sm:mb-4 sm:text-3xl md:mb-6 md:text-4xl lg:mb-4 lg:text-5xl">
              KB 트리플 레벨업
              <br />
              연금보험 무배당(보증형)
            </h1>
            <ul className="mb-6 space-y-1.5 sm:mb-8 sm:space-y-2 md:mb-10 md:space-y-3 lg:mb-8 lg:space-y-2">
              <li className="flex items-start justify-center text-base text-gray-800 sm:text-lg md:justify-center md:text-xl lg:justify-start lg:text-lg">
                <span className="mr-1.5 mt-0.5 hidden text-lg text-[#22c55e] sm:mr-2 sm:mt-1 sm:text-xl md:mr-3 md:text-2xl lg:mr-2 lg:block lg:text-xl">
                  ✔
                </span>
                <div className="text-center leading-tight sm:leading-normal md:text-center lg:text-left">
                  <span className="font-semibold text-[#e23c3c]">트리플 레벨업 보증</span>으로
                  <br />
                  <span className="font-semibold text-[#3a4ca8]">7년/10년/연금개시시점</span> 적립액
                  보증
                  <br />
                  <span className="align-baseline text-xs text-text-secondary sm:text-xs md:text-sm lg:text-xs">
                    (보증형에 한함)
                  </span>
                </div>
              </li>
              <li className="flex items-center justify-center text-base text-gray-800 sm:text-lg md:justify-center md:text-xl lg:justify-start lg:text-lg">
                <span className="mr-1.5 text-lg text-[#22c55e] sm:mr-2 sm:text-xl md:mr-3 md:text-2xl lg:mr-2 lg:text-xl">
                  ✔
                </span>
                가입&nbsp;<span className="font-semibold text-[#3a4ca8]">0~70세</span>
                &nbsp;/&nbsp;연금개시&nbsp;
                <span className="font-semibold text-[#3a4ca8]">45~85세</span>
              </li>
              <li className="flex items-center justify-center text-base text-gray-800 sm:text-lg md:justify-center md:text-xl lg:justify-start lg:text-lg">
                <span className="mr-1.5 text-lg text-[#22c55e] sm:mr-2 sm:text-xl md:mr-3 md:text-2xl lg:mr-2 lg:text-xl">
                  ✔
                </span>
                <span className="font-semibold text-[#3a4ca8]">비과세</span>&nbsp;
                <span className="align-baseline text-xs text-text-secondary sm:text-xs md:text-sm lg:text-xs">
                  (월 150만원 한도, 10년유지 세법요건 충족시)
                </span>
              </li>
              <li className="flex items-center justify-center pr-16 text-base text-gray-800 sm:pr-20 sm:text-lg md:justify-center md:pr-24 md:text-xl lg:justify-start lg:pr-8 lg:text-lg">
                <span className="mr-1.5 text-lg text-[#22c55e] sm:mr-2 sm:text-xl md:mr-3 md:text-2xl lg:mr-2 lg:text-xl">
                  ✔
                </span>
                <span className="font-semibold text-[#e23c3c]">병력 무심사</span>&nbsp;/&nbsp;
            ...
            <div className="relative">
              <img
                ...
                className="absolute -top-12 right-0 z-20 h-auto w-[70px] animate-[wobble-shake_2s_ease-in-out_infinite] rounded-lg sm:w-[75px] md:-top-10 md:right-1 md:w-[80px] lg:-top-16 lg:right-2 lg:w-[85px] xl:w-[90px]"
              />
              <div className="mx-auto mb-3 w-full max-w-2xl rounded-xl bg-white p-2 px-2 pb-3 pt-3 shadow-lg sm:mb-4 sm:p-3 sm:px-3 sm:pb-4 sm:pt-4 md:p-4 md:px-4 md:pb-5 md:pt-5 lg:max-w-3xl lg:p-3 lg:px-3 lg:pb-5 lg:pt-5">
                <div className="mb-2 grid grid-cols-3 gap-2 sm:gap-4 md:gap-2">
                  <div className="px-1 text-center sm:px-2">
                    <div className="relative mb-1 text-sm font-bold tracking-wide text-orange-600 sm:mb-2 sm:text-base md:text-base">
                      <span
                        className="relative inline-block px-1"
                        style={{
                          background:
                            'linear-gradient(transparent 70%, #fef3cd 70%, #fef3cd 100%, transparent 100%)',
                        }}
                      >
                        보증 1
                      </span>
                    ...
                    <div
                      className="mb-2 inline-block translate-y-0 transform whitespace-nowrap rounded-lg bg-gradient-to-b from-[#ff8c1a] via-[#f97316] to-[#ea580c] px-2 py-1.5 text-xs font-bold text-white transition-transform hover:translate-y-[-2px] sm:px-4 sm:py-2 sm:text-sm md:text-base"
                      style={{
                        boxShadow:
                          '0 6px 12px rgba(234, 88, 12, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.2), inset 0 -1px 0 rgba(0, 0, 0, 0.1)',
                      }}
                    >
                      7년 시점
                    </div>
                    <div className="flex flex-col items-center">
                      <img
                        src="/images/img-piggy-bank-3d.png"
                        alt="저금통"
                        className="mx-auto mb-1 h-6 w-6 sm:mb-2 sm:h-8 sm:w-8 md:h-12 md:w-12"
                      />
                      <div className="text-xs font-bold sm:text-xs md:text-sm">환급률</div>
                      <div className="text-2xl font-extrabold text-[#ff8c1a] sm:text-3xl md:text-4xl">
                        100%
                      </div>
                      <div className="mt-1 text-xs text-text-muted">* 5년납</div>
                    </div>
                  </div>
                  <div className="px-1 text-center sm:px-2">
                    <div className="relative mb-1 text-sm font-bold tracking-wide text-pink-600 sm:mb-2 sm:text-base md:text-base">
                      <span
                        className="relative inline-block px-1"
                        style={{
                          background:
                            'linear-gradient(transparent 70%, #fdf2f8 70%, #fdf2f8 100%, transparent 100%)',
                        }}
                      >
                        보증 2
                      </span>
                    ...
                    <div
                      className="mb-2 inline-block translate-y-0 transform whitespace-nowrap rounded-lg bg-gradient-to-b from-[#e23c3c] via-[#dc2626] to-[#b91c1c] px-2 py-1.5 text-xs font-bold text-white transition-transform hover:translate-y-[-2px] sm:px-4 sm:py-2 sm:text-sm md:text-base"
                      style={{
                        boxShadow:
                    ...
                    <div className="flex flex-col items-center">
                      <div className="relative mx-auto mb-1 h-6 w-6 overflow-hidden rounded-full before:absolute before:left-[-100%] before:top-0 before:h-full before:w-full before:skew-x-12 before:animate-[shine-inline_1.5s_linear_infinite] before:bg-gradient-to-r before:from-transparent before:via-white/50 before:to-transparent sm:mb-2 sm:h-8 sm:w-8 md:h-12 md:w-12">
                        <img
                          src="/images/img-money-bag-3d.png"
                          alt="돈자루"
                          className="h-full w-full object-contain"
                        />
                      </div>
                      <div className="text-xs font-bold sm:text-xs md:text-sm">환급률</div>
                      <div className="animate-[jump-glow_1.2s_ease-in-out_infinite] text-2xl font-extrabold text-[#e23c3c] sm:text-3xl md:text-4xl">
                        130%
                      </div>
                      <div className="mt-1 whitespace-nowrap text-xs text-text-muted">* 5년납</div>
                    </div>
                  </div>
                  <div className="px-1 text-center sm:px-2">
                    <div className="relative mb-1 text-sm font-bold tracking-wide text-brand-primary sm:mb-2 sm:text-base md:text-base">
                      <span
                        className="relative inline-block px-1"
                        style={{
                          background:
                            'linear-gradient(transparent 70%, #dbeafe 70%, #dbeafe 100%, transparent 100%)',
                        }}
                      >
                        보증 3
                      </span>
                    ...
                    <div
                      className="mb-2 inline-block translate-y-0 transform whitespace-nowrap rounded-lg bg-gradient-to-b from-[#3a80e0] via-[#2563eb] to-[#1d4ed8] px-1.5 py-1.5 text-xs font-bold text-white transition-transform hover:translate-y-[-2px] sm:px-2 sm:py-2 sm:text-xs md:text-base"
                      style={{
                        boxShadow:
                    ...
                    <div className="flex flex-col items-center">
                      <img
                        src="/images/img-clock-3d.png"
                        alt="시계"
                        className="mx-auto mb-1 h-6 w-6 sm:mb-2 sm:h-8 sm:w-8 md:h-12 md:w-12"
                      />
                      <div className="text-xs font-bold sm:text-xs md:text-sm">계약자적립액</div>
                      <div className="text-xl font-extrabold text-[#3a80e0] sm:text-2xl md:text-4xl">
                        2.0%
                      </div>
                      <div className="mt-1 text-center text-xs text-text-muted lg:whitespace-nowrap">
                        (연금을 개시하는 경우에 한함)
                      </div>
                    </div>
                  </div>
                </div>
                <div className="mt-1 text-center text-xs text-text-muted sm:mt-2">
                  <p>* 트리플 레벨업 보증률 반영 (보증형에 한함)</p>
                </div>
              </div>
            </div>
          </div>
              ...
              >
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <div className="flex gap-2">
                      <label
                        className={`flex flex-1 cursor-pointer items-center justify-center gap-1.5 rounded-lg border-2 py-2.5 transition-all ${gender === 'M' ? 'border-[#f97316] bg-[#f97316]/5 text-[#f97316]' : 'border-border-default hover:border-border-default'}`}
                      >
                        <input
                          type="radio"
                          name="gender"
                      ...
                      <label
                        className={`flex flex-1 cursor-pointer items-center justify-center gap-1.5 rounded-lg border-2 py-2.5 transition-all ${gender === 'F' ? 'border-[#f97316] bg-[#f97316]/5 text-[#f97316]' : 'border-border-default hover:border-border-default'}`}
                      >
                        <input
                          type="radio"
                          name="gender"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-lg border border-border-default px-3 py-2.5 text-sm transition-all focus:border-[#f97316] focus:ring-2 focus:ring-[#f97316]/20"
                      placeholder="홍길동"
                    />
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {['5년', '7년', '10년'].map((period) => (
                      <label key={period} className="relative cursor-pointer">
                        {period === '5년' && (
                          <span className="absolute -top-3 left-1/2 z-10 -translate-x-1/2 animate-bounce rounded-full bg-gradient-to-r from-[#f97316] to-[#ea580c] px-2.5 py-0.5 text-xs font-bold text-white shadow-lg">
                            추천
                          </span>
                        )}
                        <input
                        ...
                        />
                        <div
                          className={`w-full rounded-lg border-2 py-2.5 text-center text-sm transition-all ${paymentPeriod === period ? 'border-[#f97316] bg-[#f97316]/5 font-bold text-[#f97316]' : 'border-border-default hover:border-border-default'}`}
                        >
                          {period}
                        </div>
                      </label>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {['30만원', '50만원', '100만원'].map((amount) => (
                      <label key={amount} className="cursor-pointer">
                        ...
                        />
                        <div
                          className={`w-full rounded-lg border-2 py-2.5 text-center text-sm transition-all ${paymentAmount === amount ? 'border-[#f97316] bg-[#f97316]/5 font-bold text-[#f97316]' : 'border-border-default hover:border-border-default'}`}
                        >
                          {amount}
                        </div>
                      </label>
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="h-4 w-4 cursor-pointer rounded border-border-default text-[#f97316] focus:ring-[#f97316]"
                  />
                  <span className="text-xs text-text-secondary">
                    ...
                    <button
                      ...
                      className="ml-1 text-[#f97316] underline hover:text-[#ea580c]"
                    >
                      자세히 보기
                    </button>
                  </span>
                ...
                <div className="mt-1 flex flex-col gap-2">
                  <button
                    type="submit"
                    className="flex w-full cursor-pointer items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#f97316] to-[#ea580c] py-3.5 text-base font-bold text-white shadow-lg shadow-[#f97316]/25 transition hover:opacity-95"
                  >
