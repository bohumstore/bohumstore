    ...
    <div className="space-y-8 px-2 sm:px-4 md:px-8 py-4 md:py-6">
      <div className="mb-2">
        ...
        <div className="text-xs text-gray-600 text-right ml-2 pb-0.5 mt-2">
          기준 : 주계약, 남자 40세, 보증형, 5년납, 65세 연금개시, 월보험료 50만원, 단위 : 만원
        </div>
      </div>
      {/* 표 */}
        ...
        <table className="w-full text-center text-xs md:text-sm table-fixed">
          ...
          <thead>
            <tr className="bg-[#1e3a8a] text-white align-middle">
              ...
              <th className="border border-gray-300 p-0.5 text-[10px] md:text-sm" rowSpan={2}>나이<br />(세)</th>
              <th className="border border-gray-300 p-0.5 text-[10px] md:text-sm" rowSpan={2}>납입보험료<br />누계<br />합계<br />(A)</th>
              <th className="border border-gray-300 p-0.5 text-[10px] md:text-sm" colSpan={2}>최저보증이율 가정시</th>
              <th className="border border-gray-300 p-0.5 text-[10px] md:text-sm" colSpan={2}>2026년08월 현재<br />평균공시이율(2.5%)<br />가정<br />[공시이율(2.55%)을<br />상한으로 함]</th>
              <th className="border border-gray-300 p-0.5 text-[10px] md:text-sm" colSpan={2}>2026년08월 현재<br />공시이율(2.55%)<br />가정</th>
            </tr>
            <tr className="bg-[#1e3a8a] text-white">
              <th className="border border-gray-300 p-0.5 text-[10px] md:text-sm">해약<br />환급금(B)</th>
              <th className="border border-gray-300 p-0.5 text-[10px] md:text-sm">환급률<br />(B/A)</th>
              <th className="border border-gray-300 p-0.5 text-[10px] md:text-sm">해약<br />환급금(C)</th>
              <th className="border border-gray-300 p-0.5 text-[10px] md:text-sm">환급률<br />(C/A)</th>
              <th className="border border-gray-300 p-0.5 text-[10px] md:text-sm">해약<br />환급금(D)</th>
      ...
      <ol className="text-xs md:text-sm text-gray-800 space-y-1 pl-4 list-decimal">
        ...
        <li>상기 예시금액은 감독규정 제 1-2조 제13호에 따른 현재 평균공시이율 2.5%, 현재 (2026년08월)의 공시이율 2.55%을 기준으로 계산한 금액입니다.</li>
        <li>실제 해약환급금은 공시이율을 적용하여 계산되며, 공시이율 변동시 해약환급금도 변동됩니다.</li>
        <li>이 보험계약을 중도해지할 경우 해약환급금은 납입한 보험료에서 경과된 기간의 위험보험료, 사업비(해약공제금액 포함), 최저사망적립액 보증비용, 트리플레벨업 보증비용 등이 차감되므로 납입한 보험료보다 적거나 없을 수도 있습니다.</li>
        ...
        <li>평균공시이율(감독규정 제1-2조 제13호)은 감독원장이 정하는 바에 따라 산정한 전체 보험회사 공시이율의 평균으로, 2026년08월 현재 2.5%입니다.</li>
        ...
        <li>트리플레벨업 보증은 감액 또는 중도인출이 발생한 경우 <span className='text-[#e11d48]'>기본보험료 계약자적립액에 비례하여 감소</span>하며, <span className='text-[#e11d48]'>중도인출금액을 재납입하더라도 원복되지 않습니다.</span></li>
      </ol>
      {/* 두 번째 해약환급금 예시표 헤더 */}
      <div className="mt-16 mb-2">
        ...
        <div className="text-xs text-gray-600 text-right ml-2 pb-0.5 mt-2">
          기준 : 주계약, 남자 40세, 보증형, 5년납, 65세 연금개시, 월보험료 50만원, 단위 : 원
        </div>
      </div>
      {/* 연금지급액 예시표 표 */}
      <div className="overflow-x-auto">
        <table className="w-full text-center text-xs md:text-sm">
          <thead>
            <tr className="bg-[#1e3a8a] text-white">
              ...
              <th className="border border-gray-300 p-0.5 text-[10px] md:text-sm">2026년08월<br />평균공시이율2.5%가정<br />[공시이율(2.55%)을상한으로함]</th>
              <th className="border border-gray-300 p-0.5 text-[10px] md:text-sm">2026년08월<br />현재공시이율(2.55%)</th>
            </tr>
            <tr>
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm" colSpan={2}>연금개시시점 계약자적립액</td>
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">48,000,000</td>
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">48,000,000</td>
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">48,000,000</td>
            </tr>
          </thead>
          <tbody>
            <tr>
              ...
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">1,622,938</td>
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">2,166,263</td>
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">2,180,706</td>
            </tr>
            <tr>
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">100세 보증</td>
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">1,414,715</td>
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">1,948,759</td>
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">1,963,179</td>
            </tr>
            <tr>
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">기대여명보증</td>
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">1,628,862</td>
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">2,173,519</td>
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">2,187,992</td>
            </tr>
            <tr>
              ...
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">9,599,999</td>
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">9,980,052</td>
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">9,989,549</td>
            </tr>
            <tr>
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">10년 확정</td>
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">4,859,847</td>
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">5,297,678</td>
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">5,308,784</td>
            </tr>
            <tr>
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">15년 확정</td>
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">3,280,124</td>
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">3,744,786</td>
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">3,756,741</td>
            </tr>
            <tr>
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">20년 확정</td>
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">2,490,508</td>
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">2,974,221</td>
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">2,986,829</td>
            </tr>
            <tr>
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm font-bold" colSpan={2}>상속연금형</td>
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">236,442</td>
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">1,159,140</td>
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">1,181,747</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <ol className="text-xs md:text-sm text-gray-800 space-y-1 pl-4 list-decimal mt-2">
        <li>상기 예시금액은 최저보증이율, 평균공시이율 2.5%(현재공시이율 상한) 및 현재 <span className='text-[#e11d48]'>2026년08월</span>의 공시이율 <span className='text-[#e11d48]'>2.55</span>%을 기준으로 계산한 금액입니다.</li>
