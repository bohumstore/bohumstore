  ...
  return (
    <div className="space-y-8 px-2 sm:px-4 md:px-8 py-4 md:py-6">
        ...
        <table className="w-full text-center text-xs md:text-sm table-fixed">
          ...
          <thead>
            <tr className="bg-[#1e3a8a] text-white align-middle">
              ...
              <th className="border border-gray-300 p-0.5 text-[10px] md:text-sm" colSpan={2}>2026년09월 현재<br />평균공시이율(2.5%)<br />가정<br />[공시이율(2.51%)을<br />상한으로 함]</th>
              <th className="border border-gray-300 p-0.5 text-[10px] md:text-sm" colSpan={2}>2026년09월 현재<br />공시이율(2.51%)<br />가정</th>
            </tr>
      ...
      <ol className="text-xs md:text-sm text-gray-800 space-y-1 pl-4 list-decimal">
        ...
        <li>상기 예시금액은 감독규정 제 1-2조 제13호에 따른 현재 평균공시이율 2.5%, 현재 (2026년09월)의 공시이율 2.51%을 기준으로 계산한 금액입니다.</li>
        ...
        <li>평균공시이율(감독규정 제1-2조 제13호)은 감독원장이 정하는 바에 따라 산정한 전체 보험회사 공시이율의 평균으로, 2026년09월 현재 2.5%입니다.</li>
        ...
        <table className="w-full text-center text-xs md:text-sm">
          ...
          <tbody>
            <tr>
              ...
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">2,169,149</td>
            </tr>
            <tr>
              ...
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">1,951,639</td>
            </tr>
            <tr>
              ...
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">2,176,411</td>
            </tr>
            <tr>
              ...
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">9,981,952</td>
            </tr>
            <tr>
              ...
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">5,299,898</td>
            </tr>
            <tr>
              ...
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">3,747,176</td>
            </tr>
            <tr>
              ...
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">2,976,741</td>
            </tr>
            <tr>
              ...
              <td className="border border-gray-300 p-0.5 text-[10px] md:text-sm">1,163,663</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <ol className="text-xs md:text-sm text-gray-800 space-y-1 pl-4 list-decimal mt-2">
        <li>상기 예시금액은 최저보증이율, 평균공시이율 2.5%(현재공시이율 상한) 및 현재 <span className='text-[#e11d48]'>2026년09월</span>의 공시이율 <span className='text-[#e11d48]'>2.51</span>%을 기준으로 계산한 금액입니다.</li>
