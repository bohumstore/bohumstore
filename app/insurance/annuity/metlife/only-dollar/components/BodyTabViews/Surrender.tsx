  ...
  return (
    <div className="space-y-8 px-2 sm:px-4 md:px-8 py-4 md:py-6">
      <div className="mb-2">
        ...
        <div className="flex justify-between items-start mt-2">
          ...
          <div className="text-right text-xs text-gray-600">
            <p>단위 : 달러 (달러미만절사)</p>
            <p>예시기준 : 남자 40세, 5년납, 90세연금지급개시, 월보험료 200달러</p>
          </div>
        </div>
      </div>
        ...
        <table className="w-full text-center text-xs md:text-sm border-collapse">
          <thead>
            <tr className="bg-[#1e3a8a] text-white align-middle">
              ...
              <th className="border border-gray-300 p-1 md:p-2" colSpan={2}>③현재 공시이율 4.66% 가정</th>
            </tr>
          ...
          <tbody>
            ...
            <tr><td className="border border-gray-300 p-1 md:p-2">11년</td><td className="border border-gray-300 p-1 md:p-2">51세</td><td className="border border-gray-300 p-1 md:p-2">12,000</td><td className="border border-gray-300 p-1 md:p-2">15,419</td><td className="border border-gray-300 p-1 md:p-2">128.49%</td><td className="border border-gray-300 p-1 md:p-2">15,697</td><td className="border border-gray-300 p-1 md:p-2">130.81%</td><td className="border border-gray-300 p-1 md:p-2">16,031</td><td className="border border-gray-300 p-1 md:p-2">133.59%</td></tr>
            <tr><td className="border border-gray-300 p-1 md:p-2">12년</td><td className="border border-gray-300 p-1 md:p-2">52세</td><td className="border border-gray-300 p-1 md:p-2">12,000</td><td className="border border-gray-300 p-1 md:p-2">15,238</td><td className="border border-gray-300 p-1 md:p-2">126.98%</td><td className="border border-gray-300 p-1 md:p-2">15,797</td><td className="border border-gray-300 p-1 md:p-2">131.64%</td><td className="border border-gray-300 p-1 md:p-2">16,482</td><td className="border border-gray-300 p-1 md:p-2">137.35%</td></tr>
            <tr><td className="border border-gray-300 p-1 md:p-2">13년</td><td className="border border-gray-300 p-1 md:p-2">53세</td><td className="border border-gray-300 p-1 md:p-2">12,000</td><td className="border border-gray-300 p-1 md:p-2">15,055</td><td className="border border-gray-300 p-1 md:p-2">125.46%</td><td className="border border-gray-300 p-1 md:p-2">15,900</td><td className="border border-gray-300 p-1 md:p-2">132.50%</td><td className="border border-gray-300 p-1 md:p-2">16,955</td><td className="border border-gray-300 p-1 md:p-2">141.29%</td></tr>
            <tr><td className="border border-gray-300 p-1 md:p-2">14년</td><td className="border border-gray-300 p-1 md:p-2">54세</td><td className="border border-gray-300 p-1 md:p-2">12,000</td><td className="border border-gray-300 p-1 md:p-2">14,871</td><td className="border border-gray-300 p-1 md:p-2">123.93%</td><td className="border border-gray-300 p-1 md:p-2">16,005</td><td className="border border-gray-300 p-1 md:p-2">133.38%</td><td className="border border-gray-300 p-1 md:p-2">17,449</td><td className="border border-gray-300 p-1 md:p-2">145.41%</td></tr>
            <tr><td className="border border-gray-300 p-1 md:p-2">15년</td><td className="border border-gray-300 p-1 md:p-2">55세</td><td className="border border-gray-300 p-1 md:p-2">12,000</td><td className="border border-gray-300 p-1 md:p-2">14,685</td><td className="border border-gray-300 p-1 md:p-2">122.38%</td><td className="border border-gray-300 p-1 md:p-2">16,113</td><td className="border border-gray-300 p-1 md:p-2">134.28%</td><td className="border border-gray-300 p-1 md:p-2">17,967</td><td className="border border-gray-300 p-1 md:p-2">149.73%</td></tr>
            <tr><td className="border border-gray-300 p-1 md:p-2">16년</td><td className="border border-gray-300 p-1 md:p-2">56세</td><td className="border border-gray-300 p-1 md:p-2">12,000</td><td className="border border-gray-300 p-1 md:p-2">14,499</td><td className="border border-gray-300 p-1 md:p-2">120.83%</td><td className="border border-gray-300 p-1 md:p-2">16,224</td><td className="border border-gray-300 p-1 md:p-2">135.20%</td><td className="border border-gray-300 p-1 md:p-2">18,508</td><td className="border border-gray-300 p-1 md:p-2">154.23%</td></tr>
            <tr><td className="border border-gray-300 p-1 md:p-2">17년</td><td className="border border-gray-300 p-1 md:p-2">57세</td><td className="border border-gray-300 p-1 md:p-2">12,000</td><td className="border border-gray-300 p-1 md:p-2">14,311</td><td className="border border-gray-300 p-1 md:p-2">119.26%</td><td className="border border-gray-300 p-1 md:p-2">16,337</td><td className="border border-gray-300 p-1 md:p-2">136.14%</td><td className="border border-gray-300 p-1 md:p-2">19,075</td><td className="border border-gray-300 p-1 md:p-2">158.96%</td></tr>
            <tr><td className="border border-gray-300 p-1 md:p-2">18년</td><td className="border border-gray-300 p-1 md:p-2">58세</td><td className="border border-gray-300 p-1 md:p-2">12,000</td><td className="border border-gray-300 p-1 md:p-2">14,121</td><td className="border border-gray-300 p-1 md:p-2">117.68%</td><td className="border border-gray-300 p-1 md:p-2">16,453</td><td className="border border-gray-300 p-1 md:p-2">137.11%</td><td className="border border-gray-300 p-1 md:p-2">19,668</td><td className="border border-gray-300 p-1 md:p-2">163.90%</td></tr>
            <tr><td className="border border-gray-300 p-1 md:p-2">19년</td><td className="border border-gray-300 p-1 md:p-2">59세</td><td className="border border-gray-300 p-1 md:p-2">12,000</td><td className="border border-gray-300 p-1 md:p-2">13,931</td><td className="border border-gray-300 p-1 md:p-2">116.09%</td><td className="border border-gray-300 p-1 md:p-2">16,572</td><td className="border border-gray-300 p-1 md:p-2">138.10%</td><td className="border border-gray-300 p-1 md:p-2">20,289</td><td className="border border-gray-300 p-1 md:p-2">169.08%</td></tr>
            <tr><td className="border border-gray-300 p-1 md:p-2">20년</td><td className="border border-gray-300 p-1 md:p-2">60세</td><td className="border border-gray-300 p-1 md:p-2">12,000</td><td className="border border-gray-300 p-1 md:p-2">13,739</td><td className="border border-gray-300 p-1 md:p-2">114.49%</td><td className="border border-gray-300 p-1 md:p-2">16,694</td><td className="border border-gray-300 p-1 md:p-2">139.12%</td><td className="border border-gray-300 p-1 md:p-2">20,939</td><td className="border border-gray-300 p-1 md:p-2">174.49%</td></tr>
            <tr><td className="border border-gray-300 p-1 md:p-2">25년</td><td className="border border-gray-300 p-1 md:p-2">65세</td><td className="border border-gray-300 p-1 md:p-2">12,000</td><td className="border border-gray-300 p-1 md:p-2">12,757</td><td className="border border-gray-300 p-1 md:p-2">106.31%</td><td className="border border-gray-300 p-1 md:p-2">17,350</td><td className="border border-gray-300 p-1 md:p-2">144.58%</td><td className="border border-gray-300 p-1 md:p-2">24,670</td><td className="border border-gray-300 p-1 md:p-2">205.58%</td></tr>
            <tr>
              <td className="border border-gray-300 p-1 md:p-2">30년</td>
              <td className="border border-gray-300 p-1 md:p-2">70세</td>
              <td className="border border-gray-300 p-1 md:p-2">12,000</td>
              <td className="border border-gray-300 p-1 md:p-2">21,600</td>
              <td className="border border-gray-300 p-1 md:p-2">180.00%</td>
              <td className="border border-gray-300 p-1 md:p-2">21,600</td>
              <td className="border border-gray-300 p-1 md:p-2">180.00%</td>
              <td className="border border-gray-300 p-1 md:p-2">29,354</td>
              <td className="border border-gray-300 p-1 md:p-2">244.62%</td>
            </tr>
            <tr><td className="border border-gray-300 p-1 md:p-2">35년</td><td className="border border-gray-300 p-1 md:p-2">75세</td><td className="border border-gray-300 p-1 md:p-2">12,000</td><td className="border border-gray-300 p-1 md:p-2">22,176</td><td className="border border-gray-300 p-1 md:p-2">184.80%</td><td className="border border-gray-300 p-1 md:p-2">24,239</td><td className="border border-gray-300 p-1 md:p-2">201.99%</td><td className="border border-gray-300 p-1 md:p-2">36,652</td><td className="border border-gray-300 p-1 md:p-2">305.43%</td></tr>
            <tr><td className="border border-gray-300 p-1 md:p-2">40년</td><td className="border border-gray-300 p-1 md:p-2">80세</td><td className="border border-gray-300 p-1 md:p-2">12,000</td><td className="border border-gray-300 p-1 md:p-2">22,773</td><td className="border border-gray-300 p-1 md:p-2">189.78%</td><td className="border border-gray-300 p-1 md:p-2">27,225</td><td className="border border-gray-300 p-1 md:p-2">226.88%</td><td className="border border-gray-300 p-1 md:p-2">45,815</td><td className="border border-gray-300 p-1 md:p-2">381.79%</td></tr>
            <tr><td className="border border-gray-300 p-1 md:p-2">45년</td><td className="border border-gray-300 p-1 md:p-2">85세</td><td className="border border-gray-300 p-1 md:p-2">12,000</td><td className="border border-gray-300 p-1 md:p-2">23,391</td><td className="border border-gray-300 p-1 md:p-2">194.93%</td><td className="border border-gray-300 p-1 md:p-2">30,603</td><td className="border border-gray-300 p-1 md:p-2">255.03%</td><td className="border border-gray-300 p-1 md:p-2">57,322</td><td className="border border-gray-300 p-1 md:p-2">477.68%</td></tr>
            <tr><td className="border border-gray-300 p-1 md:p-2">49년</td><td className="border border-gray-300 p-1 md:p-2">89세</td><td className="border border-gray-300 p-1 md:p-2">12,000</td><td className="border border-gray-300 p-1 md:p-2">23,901</td><td className="border border-gray-300 p-1 md:p-2">199.18%</td><td className="border border-gray-300 p-1 md:p-2">33,623</td><td className="border border-gray-300 p-1 md:p-2">280.19%</td><td className="border border-gray-300 p-1 md:p-2">68,613</td><td className="border border-gray-300 p-1 md:p-2">571.78%</td></tr>
            <tr><td className="border border-gray-300 p-1 md:p-2">50년</td><td className="border border-gray-300 p-1 md:p-2">90세</td><td className="border border-gray-300 p-1 md:p-2">12,000</td><td className="border border-gray-300 p-1 md:p-2">24,030</td><td className="border border-gray-300 p-1 md:p-2">200.25%</td><td className="border border-gray-300 p-1 md:p-2">34,425</td><td className="border border-gray-300 p-1 md:p-2">286.88%</td><td className="border border-gray-300 p-1 md:p-2">71,772</td><td className="border border-gray-300 p-1 md:p-2">598.10%</td></tr>
          </tbody>
        </table>
      </div>
      ...
      <div className="mt-4 space-y-2 text-xs md:text-sm text-gray-800">
        <p>※상기 예시된 금액 및 환급률은 7년 및 10년 경과시점의 최저계약자적립액 보증을 반영한 금액이며, 계약해당일이 도래하기 이전에 해지시 예시된 금액과 다를 수 있습니다. 다만, 연금개시시점 최저계약자적립액 보증은 연금을 개시하는 경우에 한하여 보증해드리므로, 연금개시시점 최저계약자적립액 보증은 반영하기 전 금액입니다.</p>
      </div>
      ...
      <div className="mt-6 space-y-3">
        ...
        <div className="space-y-2 text-xs md:text-sm text-gray-800">
          ...
          <p>ㆍ`해약환급금 및 환급률 예시` 에서 ②은 감독규정 제1-2조 제13호에 따른 2026년 5월 현재 평균공시이율2.50%와 2026년 5월 현재 공시이율 4.66% 중 작은 이율을 적용하여 계산한 금액입니다.</p>
          <p>ㆍ`해약환급금 및 환급률 예시` 에서 ③은 2026년 5월 현재 공시이율 4.66%을 적용하여 계산한 금액입니다.</p>
          ...
          <p>ㆍ연금개시시점보다 계약일로부터 30년 경과시점이 먼저 도래할 경우, 30년 경과시점의 최저계약자적립액 보증을 반영한 금액이며, 계약해당일이 도래하기 이전에 해지시 예시된 금액과 다를 수 있습니다. 다만, 연금개시시점이 계약일로부터 30년 경과시점보다 먼저 도래할 경우 연금을 개시하는 경우에 한하여 보증해드리므로, 연금개시시점 최저계약자적립액 보증은 반영하기 전 금액입니다.</p>
      ...
      <div className="mt-6 space-y-3">
        ...
        <div className="space-y-2 text-xs md:text-sm text-gray-800">
          <p>ㆍ이 보험의 연금계약적립액 산출이 적용되는 공시이율은 매월 변동되며, 2026년 5월 현재 연복리 4.66%이고, 최저보증이율은 가입 후 5년 이내에 1.0%, 5년을 초과하는 경우에는 연복리 0.7%입니다. 회사는 운용자산이익률과 시장금리를 기준으로 향후 예상수익 등 경영환경을 고려하여 공시이율을 결정합니다.</p>
