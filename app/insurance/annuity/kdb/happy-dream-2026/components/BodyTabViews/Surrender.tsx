      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
          <div className="space-y-2">
            <p className="text-gray-700"><span className="text-red-600">이 보험계약은 약관에서 보험회사가 최저보증하는 보험금 및 특약에 한하여 예금자보호법에 따라 보호됩니다.</span> 보호한도는 해약환급금(또는 만기 시 보험금)에 기타지급금을 합하여 1인당 "1억원까지"(본 보험회사의 여타 보호상품과 합산)이며, 이와 별도로 본 보험회사 보호상품의 사고보험금을 합산하여 1인당 "1억원까지" 입니다. 다만, 보험계약자 및 보험료 납부자가 법인인 보험 계약은 「예금자보호법」에 따라 보호되지 않습니다.</p>
          </div>
        </div>
      </div>
