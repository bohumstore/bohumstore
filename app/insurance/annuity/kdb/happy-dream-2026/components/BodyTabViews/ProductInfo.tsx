  ...
  return (
    <div className="space-y-8 px-2 sm:px-4 md:px-8 py-4 md:py-6">
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-bold border-l-4 border-[#1e3a8a] pl-3">연금기준금액</h3>
      ...
      {/* 실적배당 종신연금 보증지급 */}
      <div className="space-y-4">
        <h3 className="text-xl font-bold border-l-4 border-[#1e3a8a] pl-3">실적배당 종신연금 보증지급</h3>
        <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
          <div className="space-y-4">
            <div className="space-y-2 text-sm">
            ...
            <div>
              ...
              <div className="space-y-3">
                <div>
                  <div className="text-xs sm:text-sm font-semibold mb-2">기본보험료 대비 보증비용</div>
                  <div className="overflow-x-auto">
                    <table className="w-full border-collapse">
                      <thead>
                        <tr className="bg-[#1e3a8a] text-white">
                      ...
                      <tbody>
                        <tr>
                          <td className="border border-gray-300 p-1 sm:p-2 md:p-3 text-xs sm:text-sm">계약일부터 10년 이내</td>
                          <td className="border border-gray-300 p-1 sm:p-2 md:p-3 text-xs sm:text-sm">매년 기본보험료 X 12 X Min(10, 납입기간)의 3.0%</td>
                        </tr>
                        <tr>
                          <td className="border border-gray-300 p-1 sm:p-2 md:p-3 text-xs sm:text-sm">계약일부터 15년 이내</td>
                          <td className="border border-gray-300 p-1 sm:p-2 md:p-3 text-xs sm:text-sm">매년 기본보험료 X 12 X Min(10, 납입기간)의 2.5%</td>
                        </tr>
                        <tr>
                          <td className="border border-gray-300 p-1 sm:p-2 md:p-3 text-xs sm:text-sm">계약일부터 20년 이내</td>
                          <td className="border border-gray-300 p-1 sm:p-2 md:p-3 text-xs sm:text-sm">매년 기본보험료 X 12 X Min(10, 납입기간)의 0.75%</td>
                        </tr>
                        <tr>
                          <td className="border border-gray-300 p-1 sm:p-2 md:p-3 text-xs sm:text-sm">계약일부터 20년 후</td>
                          <td className="border border-gray-300 p-1 sm:p-2 md:p-3 text-xs sm:text-sm">매년 기본보험료 X 12 X Min(10, 납입기간)의 0.5%</td>
                        </tr>
                        <tr>
                          <td className="border border-gray-300 p-1 sm:p-2 md:p-3 text-xs sm:text-sm">연금개시 후</td>
                          <td className="border border-gray-300 p-1 sm:p-2 md:p-3 text-xs sm:text-sm">매년 기본보험료 X 12 X Min(10, 납입기간)의 0.5%</td>
                        </tr>
                      </tbody>
                    </table>
                ...
                <div>
                  <div className="text-xs sm:text-sm font-semibold mb-2">계약자적립액 대비 보증비용</div>
                  <div className="overflow-x-auto">
                    <table className="w-full border-collapse">
                      <thead>
                        <tr className="bg-[#1e3a8a] text-white">
                      ...
                      <tbody>
                        <tr>
                          <td className="border border-gray-300 p-1 sm:p-2 md:p-3 text-xs sm:text-sm">연금개시 전</td>
                          <td className="border border-gray-300 p-1 sm:p-2 md:p-3 text-xs sm:text-sm">매년 계약자적립액의 1.5%</td>
                        </tr>
                        <tr>
                          <td className="border border-gray-300 p-1 sm:p-2 md:p-3 text-xs sm:text-sm">연금개시 후</td>
                          <td className="border border-gray-300 p-1 sm:p-2 md:p-3 text-xs sm:text-sm">매년 계약자적립액의 1.5%</td>
      ...
      {/* 경제적 상황에 따라 유연한 자금운용 */}
      <div className="space-y-4">
        <h3 className="text-xl font-bold border-l-4 border-[#1e3a8a] pl-3">경제적 상황에 따라 유연한 자금운용</h3>
        <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
          <div className="space-y-4">
            <p className="text-base leading-relaxed">
              ...
              <table className="w-full border-collapse">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="border border-gray-300 p-1 sm:p-2 md:p-3 text-xs sm:text-sm">더! 행복드림 변액연금보험(무)</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className="border border-gray-300 p-1 sm:p-2 md:p-3 text-xs sm:text-sm">만15세 ~ 60세</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className="border border-gray-300 p-1 sm:p-2 md:p-3 text-xs sm:text-sm leading-tight sm:leading-relaxed">최소거치기간 : (20-A)년<br />(단, 20년납의 경우 5년)<br />※ 최소 거치기간은 보험료 납입완료 후 연금지급개시까지 최소한의 기간</td>
                  </tr>
                </tbody>
              </table>
            </div>
