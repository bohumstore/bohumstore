  ...
  return (
    <div className="space-y-8 px-2 sm:px-4 md:px-8 py-4 md:py-6">
      ...
      <div className="space-y-4 text-sm text-gray-600">
        <p>· 보험기간 중 피보험자의 사망으로 인하여 이 약관에서 규정하는 보험금 지급사유가 더 이상 발생할 수 없는 경우에는 "보험료 및 해약환급금 산출방법서"에서 정하는 바에 따라 회사가 적립한 사망당시의 계약자적립액과 최저사망적립액 중 큰 금액을 계약자에게 지급하고 이 계약은 더 이상 효력이 없습니다.</p>
        <p>· 고도후유장해보험금의 경우 지급사유 발생 최초 1회에 한하여 지급하여 드리며, "보험료 및 해약환급금 산출방법서"에서 정한 바에 따라 계약자적립액 계산시 고도후유장해보험금 지급사유 발생일 이후 최초 도래하는 월계약해당일부터 고도후유장해보험금에 해당하는 위험보험료를 차감하지 않습니다.</p>
        ...
        <p>· 「연금기준금액」이라 함은 연금개시 후 보험기간에 최저사망적립액 및 금액보증연금 지급의 기준이 되는 금액으로서 연금개시나이 계약 해당일의 최저연금기준금액과 계약자적립액 중 큰 금액을 말합니다.</p>
