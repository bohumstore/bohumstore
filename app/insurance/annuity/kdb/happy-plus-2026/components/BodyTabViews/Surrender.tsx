    ...
    <div className="space-y-8 px-2 sm:px-4 md:px-8 py-4 md:py-6">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
          <p className="text-base leading-relaxed">계약자께서는 보험계약을 청약할 때 보험상품명, 보험기간, 보험료, 보험료납입기간, 피보험자 등을 반드시 확인하시기 바랍니다.</p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
          <p className="text-base leading-relaxed">당사 및 모집종사자는 해당 상품에 대해 충분히 설명할 의무가 있으며, 계약자는 가입에 앞서 이에 대한 충분한 설명을 받으시기 바랍니다.</p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
          <p className="text-base leading-relaxed">청약시 청약서 자필서명란에는 반드시 계약자와 피보험자 본인이 직접 서명하셔야만 보험금 지급이 보장됩니다.</p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
          <p className="text-base leading-relaxed">피보험자의 건강상태, 직업 등 청약서에서 질문한 사항에 대하여 사실대로 알려야 합니다. 그렇지 않은 경우 보험금 지급이 거절되거나 계약이 해지될 수 있으며, 계약이 해지 된 경우 해약환급금을 지급합니다.</p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
          <p className="text-base leading-relaxed">보험계약을 체결할 때 청약서에 자필서명(전자서명 포함)을 하지 않았거나 청약할 때 약관과 계약자 보관용 청약서를 전달받지 못한 경우 또는 약관의 중요한 내용을 설명받지 못한 경우에는 계약자는 계약이 성립한 날부터 3개월 이내에 계약을 취소할 수 있으며, 납입한 보험료 전액과 정해진 이자를 지급합니다.</p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
          <p className="text-base leading-relaxed">피보험자의 건강상태나 직업(위험직종) 등에 따라 가입이 거절되거나 제한될 수 있으며, 고의사고, 가입전에 발생한 보험사고는 보장되지 않습니다.</p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
          <p className="text-base leading-relaxed">기존에 체결했던 계약을 해지하고 다른 계약을 체결하는 경우에는 계약체결의 거부 또는 보험료 등 금융소비자의 지급비용이 인상되거나 보장내용이 변경될 수 있습니다.</p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
          <p className="text-base leading-relaxed">보험은 은행의 저축과는 달리 위험보장과 저축을 겸하는 제도로서, 계약자가 납입한 보험료 중 일부는 불의의 사고를 당한 다른 가입자에게 보험금으로 지급되며, 또 다른 일부는 보험회사의 운영에 필요한 경비로 사용되므로 중도 해지시 지급되는 해약환급금은 납입한 보험료보다 적거나 없을 수도 있습니다.</p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-3">
          ...
          <img src="/1m_2.png" alt="예금자보호안내" className="h-[80px]" />
        </div>
        <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
          <div className="space-y-2 text-base leading-relaxed text-red-600">
            <p>이 보험계약은 예금자보호법에 따라 해약환급금(또는 만기 시 보험금)에 기타지급금을 합한 금액이 1인당 "1억원까지"(본 보험회사의 여타 보호상품과 합산) 보호됩니다.</p>
            <p>이와 별도로 본 보험회사 보호상품의 사고보험금을 합산한 금액이 1인당 "1억원까지" 보호됩니다.</p>
            <p>다만, 보험계약자 및 보험료 납부자가 법인인 보험 계약은 「예금자보호법」에 따라 보호되지 않습니다.</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
          <p className="text-base leading-relaxed">본 안내는 법령 및 내부통제기준에 따른 광고관련 절차를 준수하여 제작되었습니다.</p>
        </div>
      </div>
        ...
        <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
          <div className="space-y-4">
            <p className="text-base leading-relaxed">
              이 계약과 관련하여 문의사항 또는 불만(민원)이 있을 경우 해당 보험모집자나 콜센터(1588-4040) 또는 인터넷 홈페이지(www.kdblife.co.kr)에 문의할 수 있고, 분쟁이 발생한 경우에는 금융감독원, 1372 소비자상담센터 등의 도움을 받을 수 있습니다. 분쟁조정 과정에서 계약자는 관계 법령에 정하는 바에 따라 회사가 기록 및 유지·관리하는 자료의 열람(사본의 제공 또는 청취를 포함)을 요구할 수 있습니다. 단, 분쟁조정의 신청이후 또는 조정신청 사건의 처리절차의 진행 중에 일방당사자가 소를 제기한 경우에는 그 조정절차가 중지될 수 있습니다.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
              <div className="bg-white p-4 rounded-lg border border-gray-300 text-center">
                <div className="text-sm text-gray-600 mb-1">당사 보험상담안내</div>
                <div className="text-xl font-bold text-[#1e3a8a]">1588-4040 (전국)</div>
              </div>
              <div className="bg-white p-4 rounded-lg border border-gray-300 text-center">
                <div className="text-sm text-gray-600 mb-1">금융감독원 민원상담전화</div>
                <div className="text-xl font-bold text-[#1e3a8a]">1332 (국번없이)</div>
              </div>
            </div>
          </div>
        </div>
