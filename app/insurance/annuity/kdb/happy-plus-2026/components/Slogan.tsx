        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-col lg:flex-row items-center md:items-center lg:items-start justify-center lg:justify-between gap-4 md:gap-8 lg:gap-12 px-4 md:px-6 lg:px-4 md:py-4 lg:py-4">
          ...
          <div className="flex-1 flex flex-col items-center md:items-center lg:items-start text-center md:text-center lg:text-left">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-3 sm:mb-4 md:mb-6 lg:mb-4 leading-tight">
              더! 행복플러스 연금보험<br />
              <span className="text-xl sm:text-2xl md:text-3xl lg:text-4xl">(보증형)(무)</span>
            </h1>
            <ul className="mb-3 sm:mb-5 md:mb-8 lg:mb-8 space-y-1 sm:space-y-1.5 md:space-y-2.5 lg:space-y-2">
              ...
              <li className="flex items-center text-sm sm:text-base md:text-lg lg:text-lg text-white justify-center md:justify-center lg:justify-start">
                <span className="text-sm sm:text-base md:text-lg lg:text-xl mr-1 sm:mr-1.5 md:mr-2.5 lg:mr-2 text-[#ffd700] flex-shrink-0">✔</span>
                <span>가입나이: 만 15~70세 / 연금개시나이: 55~80세</span>
              </li>
              <li className="flex items-center text-sm sm:text-base md:text-lg lg:text-lg text-white justify-center md:justify-center lg:justify-start">
                <span className="text-sm sm:text-base md:text-lg lg:text-xl mr-1 sm:mr-1.5 md:mr-2.5 lg:mr-2 text-[#ffd700] flex-shrink-0">✔</span>
            ...
            <div className="w-full max-w-2xl lg:max-w-3xl mx-auto bg-white rounded-xl shadow-lg mb-3 sm:mb-4 p-3 sm:p-4 md:p-5">
              <div className="grid grid-cols-3 gap-2 sm:gap-3 md:gap-4">
                ...
                <div className="flex flex-col">
                  <div className="bg-green-600 text-white text-center py-1 sm:py-1.5 md:py-2 rounded-t-lg">
                    <p className="text-[10px] sm:text-xs md:text-sm font-bold">생존 시</p>
                  </div>
                  <div className="border-2 border-green-600 rounded-b-lg p-2 sm:p-3 md:p-3.5 flex-1 flex flex-col justify-center items-center bg-green-50 min-h-[130px] sm:min-h-[140px] md:min-h-[150px]">
                    <p className="text-xs sm:text-sm md:text-base font-bold text-green-900 mb-1">최대 100세까지</p>
                    <p className="text-[9px] sm:text-[10px] md:text-xs text-gray-600 text-center leading-tight">
                      (예시) 100세<br />최종연금지급일
                    </p>
                    <div className="mt-1.5 pt-1.5 border-t border-green-200 w-full">
                ...
                <div className="flex flex-col relative overflow-hidden">
                  ...
                  <div className="border-2 border-orange-600 rounded-b-lg p-2 sm:p-3 md:p-3.5 flex-1 flex flex-col justify-center items-center bg-orange-50 relative z-10 min-h-[130px] sm:min-h-[140px] md:min-h-[150px]">
                    ...
                    <div className="w-full space-y-0.5 sm:space-y-1">
                      ...
                      <div className="bg-white rounded px-1 sm:px-1.5 md:px-2 py-0.5 sm:py-1 text-center border border-orange-200">
                        <p className="text-[8px] sm:text-[9px] md:text-[10px] text-gray-700">20년~연금개시: <span className="font-bold text-green-600">5%</span></p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                {/* 3. 사망 시에도 보장 */}
                <div className="flex flex-col">
                  <div className="bg-blue-600 text-white text-center py-1 sm:py-1.5 md:py-2 rounded-t-lg">
                    <p className="text-[10px] sm:text-xs md:text-sm font-bold">사망 시</p>
                  </div>
                  <div className="border-2 border-blue-600 rounded-b-lg p-2 sm:p-3 md:p-3.5 flex-1 flex flex-col justify-center items-center bg-blue-50 min-h-[130px] sm:min-h-[140px] md:min-h-[150px]">
                    <p className="text-xs sm:text-sm md:text-base font-bold text-blue-900 mb-1">최저사망적립액</p>
                    <p className="text-xs sm:text-sm md:text-base font-bold text-blue-900 mb-1.5">보장</p>
                    <p className="text-[9px] sm:text-[10px] md:text-xs text-gray-600 text-center leading-tight">
                      장래 공시이율과<br />관계없이
                    </p>
                  </div>
            ...
            <div id="calculator-box" className="w-full max-w-md sm:max-w-lg bg-white rounded-2xl shadow-2xl p-4 sm:p-5 md:p-6 relative flex flex-col">
              <div className="mb-4 sm:mb-5">
                <div className="flex items-center gap-2 mb-1">
                  <div className="w-7 h-7 sm:w-8 sm:h-8 bg-gradient-to-br from-[#16a34a] to-[#15803d] rounded-lg flex items-center justify-center">
              ...
              <form className="flex flex-col gap-2.5 sm:gap-3 md:gap-4" onSubmit={handleInsuranceCostCalculate}>
                ...
                <div className="grid grid-cols-2 gap-2 sm:gap-2.5 md:gap-3">
                  <div>
                    ...
                    <div className="flex gap-1.5 sm:gap-2">
                      <label className={`flex-1 flex items-center justify-center gap-1.5 py-2 sm:py-2.5 rounded-lg border-2 cursor-pointer transition-all ${gender === "M" ? 'border-[#16a34a] bg-[#16a34a]/5 text-[#16a34a]' : 'border-gray-200 hover:border-gray-300'}`}>
                      ...
                      <label className={`flex-1 flex items-center justify-center gap-1.5 py-2 sm:py-2.5 rounded-lg border-2 cursor-pointer transition-all ${gender === "F" ? 'border-[#16a34a] bg-[#16a34a]/5 text-[#16a34a]' : 'border-gray-200 hover:border-gray-300'}`}>
                  ...
                  <div>
                    ...
                    <input type="text" inputMode="text" ref={nameInputRef} value={name} onChange={handleNameChange} onFocus={handleInputFocus} onKeyDown={(e) => { if (e.key === 'Enter') { e.preventDefault(); birthInputRef.current?.focus(); } }} className="w-full px-2.5 sm:px-3 py-2 sm:py-2.5 border border-gray-200 rounded-lg text-xs sm:text-sm focus:ring-2 focus:ring-[#16a34a]/20 focus:border-[#16a34a] transition-all" placeholder="홍길동" />
                  </div>
                </div>
                    ...
                    <div className="grid grid-cols-3 gap-1.5 sm:gap-2">
                      {['30만원', '50만원', '70만원', '100만원', '130만원', '150만원'].map((amount) => (
                        <label key={amount} className="relative flex items-center justify-center cursor-pointer">
                          ...
                          />
                          <div className="w-full text-center py-2 sm:py-2.5 text-xs sm:text-sm border-2 rounded-lg cursor-pointer transition-all peer-checked:border-[#16a34a] peer-checked:bg-[#16a34a]/5 peer-checked:text-[#16a34a] peer-checked:font-bold hover:border-[#16a34a] hover:bg-gray-50 border-gray-200">
                            {amount}
                          </div>
                        </label>
                      ))}
                ...
                <div className="flex items-center gap-2 mb-4">
                  <input type="checkbox" checked={isChecked} onChange={(e) => setIsChecked(e.target.checked)} className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#16a34a] rounded border-gray-300 cursor-pointer focus:ring-[#16a34a]" />
                  <span className="text-[10px] sm:text-xs text-gray-600">
                    개인정보 수집 및 이용에 동의합니다.
                    <button type="button" onClick={onOpenPrivacy} className="text-[#16a34a] underline ml-1 hover:text-[#15803d]">자세히 보기</button>
                  </span>
                </div>

                {/* 버튼들 */}
                <div className="flex flex-col gap-1.5 sm:gap-2 mt-1">
                  <button type="submit" className="w-full bg-gradient-to-r from-[#16a34a] to-[#15803d] text-white font-bold rounded-xl py-3 sm:py-3.5 text-sm sm:text-base hover:opacity-95 transition flex items-center justify-center gap-2 shadow-lg shadow-[#16a34a]/25 cursor-pointer">
              ...
              <div className="bg-gray-50 rounded-lg p-1.5 sm:p-2">
                ...
                <div className="bg-white p-1.5 sm:p-2 rounded border border-gray-200">
                  <div className="flex justify-between items-center text-sm">
                    ...
                    <span className="font-bold text-[#3a8094]">더!행복플러스연금보험(보증형)</span>
                  </div>
                </div>
                <div className="bg-white p-1.5 sm:p-2 rounded border border-gray-200">
                  <div className="flex justify-between items-center text-sm">
