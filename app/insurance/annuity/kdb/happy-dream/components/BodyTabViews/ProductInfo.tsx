            ...
            <div>
              ...
              <table className="product-table">
                ...
                <tbody className="text-text-primary">
                  <tr>
                      <td className="product-table-td-center">기본보험료 및 추가보험료의 매년 7/100<br/><span className="text-status-red">(연단리 7%기준)</span></td>
                      <td className="product-table-td-center">기본보험료 및 추가보험료의 매년 6/100<br/><span className="text-status-red">(연단리 6%기준)</span></td>
                  </tr>
                </tbody>
              </table>
              </div>
      ...
      <div className="space-y-4">
        ...
        <div className="product-info-box">
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm">
              <div className="text-status-red">※ 단, 연금개시 후에는 사망시점의 연금기준금액에서 기지급 된 실적배당 종신연금 연지급액의 합계를 차감한 금액을 사망시 계약자적립액으로 최저보증</div>
            </div>
            <div>
        ...
        <div className="product-info-box">
          <div className="space-y-4">
            ...
            <table className="w-full border-collapse">
              ...
              <tbody>
                <tr>
                    <td className="border border-border-default p-1 sm:p-2 md:p-3 text-xs sm:text-sm font-semibold">선지급행복자금 신청 비율</td>
                    <td className="border border-border-default p-1 sm:p-2 md:p-3 text-xs sm:text-sm">최소 0%에서 30%까지 10%p 단위로 신청 가능</td>
                </tr>
                <tr>
                    <td className="border border-border-default p-1 sm:p-2 md:p-3 text-xs sm:text-sm font-semibold">선지급행복자금 기간</td>
                    <td className="border border-border-default p-1 sm:p-2 md:p-3 text-xs sm:text-sm">확정연금 지급기간으로 일시금, 5년, 10년으로 선택가능</td>
                </tr>
                <tr>
                    <td className="border border-border-default p-1 sm:p-2 md:p-3 text-xs sm:text-sm font-semibold">선지급행복자금 지급일</td>
                    <td className="border border-border-default p-1 sm:p-2 md:p-3 text-xs sm:text-sm">연금개시나이 계약해당일 이후 선지급행복자금기간 동안의 연단위 계약 해당일</td>
                </tr>
                <tr>
                    <td className="border border-border-default p-1 sm:p-2 md:p-3 text-xs sm:text-sm font-semibold">선지급행복자금 지급개시일</td>
                    <td className="border border-border-default p-1 sm:p-2 md:p-3 text-xs sm:text-sm">선지급행복자금 지급이 시작되는 날로 연금개시나이 계약해당일</td>
                </tr>
                <tr>
                    <td className="border border-border-default p-1 sm:p-2 md:p-3 text-xs sm:text-sm font-semibold">선지급행복자금 신청 후 제한사항</td>
                    <td className="border border-border-default p-1 sm:p-2 md:p-3 text-xs sm:text-sm leading-tight sm:leading-relaxed">(1) 기본보험료 감액<br/>(2) 중도인출<br/>(3) 연금개시나이 변경</td>
                </tr>
              </tbody>
            </table>
            </div>
            <div className="mt-4 space-y-2 text-sm">
              <div className="text-status-red">※ 이 상품은 실적배당형 상품이므로 보험금 및 해약환급금이 특별계정의 운용실적에 따라 변동됩니다.</div>
              <div className="text-status-red">※ 중도해지시 해약환급금에 대한 최저보증이 없으므로 원금손실이 발생할 수 있으며, 그 손실은 모두 계약자에게 귀속됩니다.</div>
              <div className="text-status-red">※ 위 내용은 요약된 것으로 보다 자세한 내용은 보험약관 및 상품설명서를 확인하시기 바랍니다.</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="product-info-box">
          <div className="space-y-4">
            ...
            <table className="w-full border-collapse">
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td className="product-table-td leading-tight sm:leading-relaxed">(무)신보험료납입면제특약 (3대질병형)<br/>※선택특약은 주계약 월납보험료 50만원 초과시 가입불가하며, 주계약 보험료 납입기간 5·7·10년 선택시에만 가입가능</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td className="product-table-td leading-tight sm:leading-relaxed">55세 ~ 80세 ※ 『보험료 납입기간 + 최소거치기간 + 가입나이』가 연금개시나이 범위 이내이어야 함.</td>
                </tr>
                <tr>
                    <td className="product-table-td font-semibold">보험기간</td>
                    <td className="product-table-td leading-tight sm:leading-relaxed">연금개시 전 보험기간 : 계약일부터 연금개시나이 계약해당일 전일까지<br/>연금개시 후 보험기간 : 연금개시나이 계약해당일부터 종신까지</td>
                </tr>
                <tr>
            ...
            <div className="mt-4 text-sm">
              <div className="text-status-red">※ 계약인수 관련 사항은 회사가 별도로 정한 기준에 따라 제한될 수 있습니다.</div>
            </div>
          </div>
        </div>
      </div>
