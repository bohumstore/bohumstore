          ...
          <div className="space-y-4">
            <div className="overflow-x-auto">
              <table className="w-full border-collapse">
                ...
                <tbody>
                  <tr>
                    <td className="border border-border-default p-1 text-xs font-semibold sm:p-2 sm:text-sm md:p-3">
                      선지급행복자금 신청 비율
                    </td>
                    <td className="border border-border-default p-1 text-xs sm:p-2 sm:text-sm md:p-3">
                  ...
                  <tr>
                    ...
                    <td className="border border-border-default p-1 text-xs leading-tight sm:p-2 sm:text-sm sm:leading-relaxed md:p-3">
                      (1) 기본보험료 감액
                      <br />
                      (2) 중도인출
                      <br />
