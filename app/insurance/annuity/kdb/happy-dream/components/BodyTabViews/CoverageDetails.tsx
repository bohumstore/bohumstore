  ...
  return (
    <div className="space-y-6 px-2 sm:px-4 md:px-8 py-3 md:py-4">
      ...
      <div className="space-y-4">
        ...
        <div className="text-sm text-text-secondary mb-2 whitespace-nowrap text-right">(기준 : 1구좌)</div>
            ...
            <table className="product-table">
              <thead>
                <tr className="product-table-header">
                    <th className="product-table-th w-[80px] sm:w-[120px] md:w-[150px]">급부명칭</th>
                    <th className="product-table-th">지급사유</th>
                    <th className="product-table-th w-[70px] sm:w-[100px] md:w-[120px]">지급금액</th>
                </tr>
              </thead>
              <tbody className="text-text-primary">
                <tr>
                    <td className="product-table-td-center text-product-primary">고도후유장해보험금</td>
                    <td className="product-table-td leading-tight sm:leading-relaxed">연금개시 전 보험기간 중 피보험자가 장해분류표 중 동일한 재해로 여러 신체부위의 장해지급률을 더하여 80% 이상인 장해상태가 되었을 때 (최초1회한)</td>
          ...
          <div className="space-y-4">
            ...
            <table className="product-table">
              <thead>
                <tr className="product-table-header">
                    <th className="product-table-th w-[80px] sm:w-[120px] md:w-[150px]">급부명칭</th>
                    <th className="product-table-th w-[90px] sm:w-[140px] md:w-[200px]">지급사유</th>
              ...
              <tbody className="text-text-primary">
                <tr>
                    ...
                    <td className="product-table-td leading-tight sm:leading-relaxed">연금개시 후 보험기간 중 피보험자가 매년 계약해당일에 살아있을 때</td>
                    <td className="product-table-td leading-tight sm:leading-relaxed">연금기준금액(다만, 연계약해당일의 계약자적립액이 더 클 경우에는 계약자적립액)을 기준으로 금액보증연금 지급률을 적용하여 계산한 금액보증연금 연지급액을 피보험자가 연계약해당일에 살아 있을 경우 지급</td>
                </tr>
              </tbody>
            </table>
            </div>
      ...
      {/* 기본 설명들 */}
      <div className="space-y-3 product-text">
        ...
        <p className="text-status-red">다만, 계약일부터 연금지급개시나이 계약해당일까지의 기간이 20년 미만인 경우 (1)에 따라 7/100로 적용합니다.</p>
        <p className="text-status-red">(3) 대표계약기준(40세 남성, 10년납, 연금개시나이 65세) 복리이자율로 환신시 연복리 4.32%</p>
        ...
        <div className="product-info-box">
          <div className="space-y-3">
            ...
            <table className="w-full border-collapse text-xs">
              <thead>
                <tr className="bg-gray-100 text-gray-700">
                    <th className="border border-border-default p-1 text-xs" rowSpan={4}>나이</th>
                    <th className="border border-border-default p-1 text-xs" colSpan={4}>투자수익률 -1.0% 가정시</th>
                    <th className="border border-border-default p-1 text-xs" colSpan={4}>투자수익률 2.75% 가정시</th>
                    <th className="border border-border-default p-1 text-xs" colSpan={4}>투자수익률 4.125% 가정시</th>
                </tr>
                <tr className="bg-gray-100 text-gray-700">
                    <th className="border border-border-default p-1 text-xs" colSpan={4}>순수익률 -4.7%</th>
                    <th className="border border-border-default p-1 text-xs" colSpan={4}>순수익률 -1.0%</th>
                    <th className="border border-border-default p-1 text-xs" colSpan={4}>순수익률 0.4%</th>
                </tr>
                <tr className="bg-gray-100 text-gray-700">
                    <th className="border border-border-default p-1 text-xs" colSpan={4}>연금기준금액: 7,390만원</th>
                    <th className="border border-border-default p-1 text-xs" colSpan={4}>연금기준금액: 7,390만원</th>
                    <th className="border border-border-default p-1 text-xs" colSpan={4}>연금기준금액: 7,390만원</th>
                </tr>
                <tr className="bg-gray-100 text-gray-700">
                    <th className="border border-border-default p-1 text-xs">연금<br/>연지급액</th>
                    <th className="border border-border-default p-1 text-xs">연금<br/>누계액</th>
                    <th className="border border-border-default p-1 text-xs">계약자<br/>적립액</th>
                    <th className="border border-border-default p-1 text-xs">최저사망<br/>적립액</th>
                    <th className="border border-border-default p-1 text-xs">연금<br/>연지급액</th>
                    <th className="border border-border-default p-1 text-xs">연금<br/>누계액</th>
                    <th className="border border-border-default p-1 text-xs">계약자<br/>적립액</th>
                    <th className="border border-border-default p-1 text-xs">최저사망<br/>적립액</th>
            ...
            <div className="space-y-2 text-sm text-text-secondary">
              <p className="text-status-red">· 연금 연지급액은 해당년도 초 기준으로 지급 가정된 금액이며, 계약자적립액 및 최저사망적립액은 해당 연금 연지급액이 지급된 직후의 예시금액입니다.</p>
              <p className="text-status-red">· 연금개시 후 보험기간에 추가적으로 중도인출을 할 경우 연금기준금액 및 계약자적립액은 감소하며, 이에 따라 연금 연지급액 및 최저사망적립액도 상기예시보다 작아지며, 선지급행복자금을 신청한 이후에는 중도인출이 제한됩니다.</p>
              ...
              <p className="text-status-red">· 상기 예시금액은 투자수익률 등 여러 가정에 따라 산출된 금액입니다. 따라서 다음 중 어느 하나의 사유가 발생한 경우, 실제 연금기준금액 및 계약자적립액이 달라져 연금 연지급액과 최저사망적립액이 예시된 금액과 다를 수 있습니다.</p>
              ...
              <p className="text-status-red">· 상기 예시된 금액은 미래의 수익을 보장하는 것은 아니며, 예시금액은 관련세법에 의한 세금공제 전 기준입니다.</p>
              <p className="text-status-red">· 보험기간 중 피보험자가 사망하였을 경우에는 사망당시의 계약자적립액(선지급행복자금 계약자 적립액 제외)과 최저사망적립액 중 큰 금액을 계약자에게 지급하고 이 계약은 더 이상효력이 없습니다.</p>
        ...
        <div className="product-info-box">
          <div className="space-y-3">
            ...
            <table className="w-full border-collapse text-xs">
              <thead>
                <tr className="bg-gray-100 text-gray-700">
                    <th className="border border-border-default p-1 text-xs" rowSpan={3}>경과년수</th>
                    <th className="border border-border-default p-1 text-xs" rowSpan={3}>나이</th>
                    <th className="border border-border-default p-1 text-xs" rowSpan={3}>납입보험료</th>
                    <th className="border border-border-default p-1 text-xs" rowSpan={3}>특별계정<br/>투입금액</th>
                    <th className="border border-border-default p-1 text-xs" colSpan={2}>투자수익률 -1.0% 가정시</th>
                    <th className="border border-border-default p-1 text-xs" colSpan={2}>투자수익률 2.75% 가정시</th>
                    <th className="border border-border-default p-1 text-xs" colSpan={2}>투자수익률 4.125% 가정시</th>
                    <th className="border border-border-default p-1 text-xs" rowSpan={3}>최저연금기준금액<br/>(해지할때<br/>지급되는<br/>금액이 아님)</th>
                </tr>
                <tr className="bg-gray-100 text-gray-700">
                    <th className="border border-border-default p-1 text-xs" colSpan={2}>순수익률 -4.7%</th>
                    <th className="border border-border-default p-1 text-xs" colSpan={2}>순수익률 -1.0%</th>
                    <th className="border border-border-default p-1 text-xs" colSpan={2}>순수익률 0.4%</th>
                </tr>
                <tr className="bg-gray-100 text-gray-700">
              ...
              <tbody className="text-text-primary">
                <tr>
                    ...
                    <td className="border border-border-default p-1 text-center text-xs">3,600,000</td>
                    <td className="border border-border-default p-1 text-center text-xs">3,287,736</td>
                    <td className="border border-border-default p-1 text-center text-xs">2,505,532</td>
                    <td className="border border-border-default p-1 text-center text-xs">69.6%</td>
                    <td className="border border-border-default p-1 text-center text-xs">2,571,299</td>
                    <td className="border border-border-default p-1 text-center text-xs">71.4%</td>
                    <td className="border border-border-default p-1 text-center text-xs">2,595,231</td>
                    <td className="border border-border-default p-1 text-center text-xs">72.1%</td>
                    <td className="border border-border-default p-1 text-center text-xs">3,736,500</td>
                </tr>
                <tr>
                    ...
                    <td className="border border-border-default p-1 text-center text-xs">10,800,000</td>
                    <td className="border border-border-default p-1 text-center text-xs">9,863,208</td>
                    <td className="border border-border-default p-1 text-center text-xs">8,625,561</td>
                    <td className="border border-border-default p-1 text-center text-xs">79.9%</td>
                    <td className="border border-border-default p-1 text-center text-xs">9,177,129</td>
                    <td className="border border-border-default p-1 text-center text-xs">85.0%</td>
                    <td className="border border-border-default p-1 text-center text-xs">9,384,825</td>
                    <td className="border border-border-default p-1 text-center text-xs">86.9%</td>
                    <td className="border border-border-default p-1 text-center text-xs">11,965,500</td>
                </tr>
                <tr>
                    ...
                    <td className="border border-border-default p-1 text-center text-xs">18,000,000</td>
                    <td className="border border-border-default p-1 text-center text-xs">16,438,680</td>
                    <td className="border border-border-default p-1 text-center text-xs">13,990,349</td>
                    <td className="border border-border-default p-1 text-center text-xs">77.7%</td>
                    <td className="border border-border-default p-1 text-center text-xs">15,475,328</td>
                    <td className="border border-border-default p-1 text-center text-xs">86.0%</td>
                    <td className="border border-border-default p-1 text-center text-xs">16,054,338</td>
                    <td className="border border-border-default p-1 text-center text-xs">89.2%</td>
                    <td className="border border-border-default p-1 text-center text-xs">21,202,500</td>
                </tr>
                <tr>
                    ...
                    <td className="border border-border-default p-1 text-center text-xs">25,200,000</td>
                    <td className="border border-border-default p-1 text-center text-xs">23,014,152</td>
                    <td className="border border-border-default p-1 text-center text-xs">18,541,110</td>
                    <td className="border border-border-default p-1 text-center text-xs">73.6%</td>
                    <td className="border border-border-default p-1 text-center text-xs">21,372,003</td>
                    <td className="border border-border-default p-1 text-center text-xs">84.8%</td>
                    <td className="border border-border-default p-1 text-center text-xs">22,515,838</td>
                    <td className="border border-border-default p-1 text-center text-xs">89.3%</td>
                    <td className="border border-border-default p-1 text-center text-xs">31,447,500</td>
                </tr>
                <tr>
                    ...
                    <td className="border border-border-default p-1 text-center text-xs">36,000,000</td>
                    <td className="border border-border-default p-1 text-center text-xs">32,877,360</td>
                    <td className="border border-border-default p-1 text-center text-xs">23,364,227</td>
                    <td className="border border-border-default p-1 text-center text-xs">64.9%</td>
                    <td className="border border-border-default p-1 text-center text-xs">28,894,817</td>
                    <td className="border border-border-default p-1 text-center text-xs">80.3%</td>
                    <td className="border border-border-default p-1 text-center text-xs">31,256,339</td>
                    <td className="border border-border-default p-1 text-center text-xs">86.8%</td>
                    <td className="border border-border-default p-1 text-center text-xs">48,705,000</td>
                </tr>
                <tr>
                    ...
                    <td className="border border-border-default p-1 text-center text-xs">36,000,000</td>
                    <td className="border border-border-default p-1 text-center text-xs">32,635,440</td>
                    <td className="border border-border-default p-1 text-center text-xs">12,072,407</td>
                    <td className="border border-border-default p-1 text-center text-xs">33.5%</td>
                    <td className="border border-border-default p-1 text-center text-xs">21,971,449</td>
                    <td className="border border-border-default p-1 text-center text-xs">61.0%</td>
                    <td className="border border-border-default p-1 text-center text-xs">26,757,571</td>
                    <td className="border border-border-default p-1 text-center text-xs">74.3%</td>
                    <td className="border border-border-default p-1 text-center text-xs">61,305,000</td>
                </tr>
                <tr>
                    <td className="border border-border-default p-1 text-center text-xs">20년</td>
                    <td className="border border-border-default p-1 text-center text-xs">60세</td>
                    <td className="border border-border-default p-1 text-center text-xs">36,000,000</td>
                    <td className="border border-border-default p-1 text-center text-xs">32,393,520</td>
                    <td className="border border-border-default p-1 text-center text-xs">-</td>
                    <td className="border border-border-default p-1 text-center text-xs">0.0%</td>
                    <td className="border border-border-default p-1 text-center text-xs">11,542,988</td>
                    <td className="border border-border-default p-1 text-center text-xs">32.1%</td>
                    <td className="border border-border-default p-1 text-center text-xs">18,663,542</td>
                    <td className="border border-border-default p-1 text-center text-xs">51.8%</td>
                    <td className="border border-border-default p-1 text-center text-xs">73,905,000</td>
                </tr>
              </tbody>
            </table>
            </div>
            <div className="space-y-2 text-sm text-text-secondary">
              <p className="text-status-red">· 이 보험계약은 납입한 보험료 중 위험보험료, 사업비 및 특약보험료를 차감한 후 특별계정(펀드)으로 투입·운용되고, 특별계정(펀드)의 투자수익률이 반영된 특별계정 계약자적립액에서 보증비용 등이 차감됩니다.</p>
              <p className="text-status-red">· 해약환급금은 특별계정 수익률에 따라 매일 변동하며, 중도해지시 특별계정 계약자적립액에서 미상각신계약비(해약공제액)를 차감하므로 해약환급금은 납입보험료보다 적거나 없을 수도 있습니다. 선지급행복자금 개시 후 중도해지한 경우, 특별계정 계약자 적립액과 선지급행복자금 계약자적립액을 합산한 금액을 지급합니다.</p>
              <p className="text-status-red">· 해약환급금에는 최저보증이 없어 원금손실이 발생할 수 있으며, 그 손실은 모두 계약자에게 귀속됩니다.</p>
              <p className="text-status-red">· 상기 예시된 금액 및 환급률 등이 미래의 수익을 보장하는 것은 아닙니다.</p>
              <p>· 특별계정(펀드) 투자수익률은 펀드의 기준가격의 변동으로 계산되며, 특별계정운용보수, 증권거래비용 및 기타비용은 매일 차감되어 기준가격에 반영되어 있습니다.</p>
              <p>· 상기 환급률은 투자수익률이 경과기간동안 일정하게 유지된다고 가정하였을 때 계약자가 납입한 보험료 대비 해약환급금의 비율입니다.</p>
              <p className="text-status-red">· 상기 해약환급금은 관련세법에 의한 세금공제 전 기준입니다.</p>
              ...
              <p className="text-status-red">· 상기 예시금액은 투자수익률 등 여러가정에 따라 산출된 금액입니다. 따라서 다음 중 어느 하나의 사유가 발생한 경우, 실제 해약환급금 및 최저연금기준금액은 예시된 금액과 다를 수 있습니다.</p>
              <div className="space-y-1 pl-4">
                <p className="text-status-red">- 매월 계약해당일에 보험료를 납입하지 않은 경우</p>
                <p className="text-status-red">- 보험료 납입일시중지를 한 경우</p>
                <p className="text-status-red">- 추가납입, 중도인출, 선납을 한 경우</p>
              ...
              <p className="text-status-red">· 연금개시 전 보험기간 중 피보험자가 사망하였을 경우에는 사망당시의 계약자적립액과 최저연금기준금액 중 큰 금액을 계약자에게 지급하고 이 계약은 더 이상 효력이 없습니다.</p>
              <p>· 상기 순수익률은 예시된 투자수익률에서 최저사망적립액 보증비용 및 실적배당 종신연금 보증비용이 차감된 후의 수익률이며, 소수점 둘째자리에서 반올림하여 계산되었습니다.</p>
            </div>
          </div>
        </div>
        ...
        <div className="product-info-box">
          <div className="space-y-4">
            ...
            <table className="w-full border-collapse">
              <tbody>
                <tr>
                    <td className="border border-border-default p-2 sm:p-3 text-xs sm:text-sm">(무)신보험료납입면제특약(3대질병형)</td>
                </tr>
              </tbody>
            </table>
            </div>
