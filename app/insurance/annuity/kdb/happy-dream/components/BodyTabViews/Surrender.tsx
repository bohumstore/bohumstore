  ...
  return (
    <div className="space-y-8 px-8 py-6">
      ...
      <div className="space-y-4">
        ...
        <div className="product-info-box">
          <p className="text-status-red">
            ...
            변동됩니다. 운용결과에 따라 납입원금의 손실이 발생할 수 있으며, 그 손실은 모두
            계약자에게 귀속됩니다. 중도해지시 해약환급금에 대한 최저보증이 없으므로 원금손실이
            발생할 수 있으며, 그 손실은 모두 계약자에게 귀속됩니다.
          </p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="product-info-box">
          <p className="text-status-red">
            중도해지시 해약환급금에 대한 최저보증이 없으므로 원금손실이 발생할 수 있으며, 그 손실은
            모두 계약자에게 귀속됩니다.
          </p>
        </div>
      </div>
