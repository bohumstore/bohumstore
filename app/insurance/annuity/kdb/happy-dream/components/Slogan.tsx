              ...
              <div className="w-full max-w-2xl lg:max-w-3xl mx-auto bg-white rounded-xl shadow-lg mb-3 sm:mb-4 p-4 sm:p-5 md:p-6 lg:p-4 px-4 sm:px-5 md:px-6 lg:px-4 pt-5 sm:pt-6 md:pt-7 lg:pt-6 pb-5 sm:pb-6 md:pb-7 lg:pb-6">
                <div className="grid grid-cols-3 gap-2 sm:gap-3 md:gap-4 lg:gap-3 mb-2 sm:mb-3">
                  ...
                  <div className="text-center p-1.5 sm:p-2 md:p-3 lg:p-3 bg-gradient-to-br from-purple-100 to-purple-200 rounded-lg shadow-md border border-purple-200 transition-all duration-300 flex flex-col justify-between min-h-[120px] sm:min-h-[140px] md:min-h-[160px]">
                    ...
                    <div className="text-[10px] sm:text-xs text-text-secondary leading-tight bg-white/50 rounded-lg p-1 sm:p-1.5">
                      = 피보험자의 99세<br />계약 해당일
                  </div>
                    </div>
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="flex items-center justify-center mb-2">
                        ...
                        <div className="text-2xl sm:text-3xl md:text-4xl font-black text-orange-600 drop-shadow-2xl animate-bounce">7%</div>
                                          ...
                                          <div className="text-[10px] sm:text-xs text-text-secondary space-y-0.5 sm:space-y-1 leading-tight relative z-10 mt-auto">
                        <div className="bg-white/60 rounded-lg p-0.5 sm:p-1 font-medium">계약일로부터<br />20년: 7%</div>
                        <div className="bg-white/60 rounded-lg p-0.5 sm:p-1 font-medium">20년~연금개시까지: <span className="text-brand-primary font-bold">6%</span></div>
                      </div>
                  </div>
            ...
            <div id="calculator-box" className="w-full max-w-md sm:max-w-lg bg-white rounded-2xl shadow-2xl p-5 sm:p-6 md:p-7 relative flex flex-col">
              <div className="mb-5 sm:mb-6">
                <div className="flex items-center gap-2 mb-1">
                  <div className="w-8 h-8 bg-gradient-to-br from-[#c084fc] to-[#9333ea] rounded-lg flex items-center justify-center">
              ...
              <form className="flex flex-col gap-3 sm:gap-4" onSubmit={handleInsuranceCostCalculate}>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <div className="flex gap-2">
                      <label className={`flex-1 flex items-center justify-center gap-1.5 py-2.5 rounded-lg border-2 cursor-pointer transition-all ${gender === "M" ? 'border-[#c084fc] bg-[#c084fc]/5 text-[#c084fc]' : 'border-border-default hover:border-border-default'}`}>
                      ...
                      <label className={`flex-1 flex items-center justify-center gap-1.5 py-2.5 rounded-lg border-2 cursor-pointer transition-all ${gender === "F" ? 'border-[#c084fc] bg-[#c084fc]/5 text-[#c084fc]' : 'border-border-default hover:border-border-default'}`}>
                  ...
                  <div>
                    ...
                    <input type="text" inputMode="text" ref={nameInputRef} value={name} onChange={handleNameChange} onFocus={handleInputFocus} onKeyDown={(e) => { if (e.key === 'Enter') { e.preventDefault(); birthInputRef.current?.focus(); } }} className="w-full px-3 py-2.5 border border-border-default rounded-lg text-sm focus:ring-2 focus:ring-[#c084fc]/20 focus:border-[#c084fc] transition-all" placeholder="홍길동" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input type="text" inputMode="numeric" pattern="[0-9]*" ref={birthInputRef} value={birth} onChange={handleBirthChange} onFocus={handleInputFocus} className="w-full px-3 py-2.5 border border-border-default rounded-lg text-sm focus:ring-2 focus:ring-[#c084fc]/20 focus:border-[#c084fc] transition-all" placeholder="19880818" maxLength={8} />
                  </div>
                  <div>
                    <label className="block text-xs font-medium text-text-secondary mb-1.5">연락처 <span className="text-status-red">*</span></label>
                    <input type="text" inputMode="numeric" pattern="[0-9]*" ref={phoneInputRef} value={phone} onChange={handlePhoneChange} onFocus={handleInputFocus} className="w-full px-3 py-2.5 border border-border-default rounded-lg text-sm focus:ring-2 focus:ring-[#c084fc]/20 focus:border-[#c084fc] transition-all" placeholder="01012345678" />
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {['10년', '15년', '20년'].map((period) => (
                      <label key={period} className="relative cursor-pointer">
                        {period === '10년' && (
                          <span className="absolute -top-3 left-1/2 -translate-x-1/2 bg-gradient-to-r from-[#c084fc] to-[#9333ea] text-white text-xs font-bold px-2.5 py-0.5 rounded-full shadow-lg z-10 animate-bounce">추천</span>
                        )}
                        ...
                        <div className={`w-full text-center py-2.5 text-sm border-2 rounded-lg transition-all ${paymentPeriod === period ? 'border-[#c084fc] bg-[#c084fc]/5 text-[#c084fc] font-bold' : 'border-border-default hover:border-border-default'}`}>
                          {period}
                        </div>
                      </label>
                    ))}
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {['30만원', '50만원', '100만원'].map((amount) => (
                      <label key={amount} className="cursor-pointer">
                        ...
                        <div className={`w-full text-center py-2.5 text-sm border-2 rounded-lg transition-all ${paymentAmount === amount ? 'border-[#c084fc] bg-[#c084fc]/5 text-[#c084fc] font-bold' : 'border-border-default hover:border-border-default'}`}>
                          {amount}
                        </div>
                      </label>
                    ))}
                ...
                <div className="flex items-center gap-2 mb-4">
                  <input type="checkbox" checked={isChecked} onChange={(e) => setIsChecked(e.target.checked)} className="w-4 h-4 text-[#c084fc] rounded border-border-default cursor-pointer focus:ring-[#c084fc]" />
                  <span className="text-xs text-text-secondary">
                    개인정보 수집 및 이용에 동의합니다. 
                    <button type="button" onClick={onOpenPrivacy} className="text-[#c084fc] underline ml-1 hover:text-[#9333ea]">자세히 보기</button>
                  </span>
                </div>

                {/* 버튼들 */}
                <div className="flex flex-col gap-2 mt-1">
                  <button type="submit" className="w-full bg-gradient-to-r from-[#c084fc] to-[#9333ea] text-white font-bold rounded-xl py-3.5 text-base hover:opacity-95 transition flex items-center justify-center gap-2 shadow-lg shadow-[#c084fc]/25 cursor-pointer">
            ...
            <>
              ...
              <div className="bg-page-bg rounded-lg p-2 mt-0">
                ...
                <button
                  ...
                  className={`w-full px-2 py-2.5 rounded-md text-base font-semibold transition-colors mt-1 ${(!isAgeEligible || verifying || otpCode.length !== 6) ? 'bg-gray-300 text-text-muted cursor-not-allowed' : 'bg-[#3a8094] text-white hover:bg-[#2c6070]'}`}
                >
