...
export default function Slogan({ onOpenPrivacy, onModalStateChange }: SloganProps) {
  ...
  const [consultType, setConsultType] = useState('더!행복플러스연금보험');
  ...
  const consultTypeOptions = ['더!행복플러스연금보험'];
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-col lg:flex-row items-center md:items-center lg:items-start justify-center lg:justify-between gap-4 md:gap-8 lg:gap-12 px-4 md:px-6 lg:px-4 md:py-4 lg:py-4">
          ...
          <div className="flex-1 flex flex-col items-center md:items-center lg:items-start text-center md:text-center lg:text-left">
            ...
            <div className="w-full max-w-2xl lg:max-w-3xl mx-auto bg-white rounded-xl shadow-lg mb-3 sm:mb-4 p-4 sm:p-5 md:p-6 lg:p-4 px-4 sm:px-5 md:px-6 lg:px-4 pt-5 sm:pt-6 md:pt-7 lg:pt-6 pb-5 sm:pb-6 md:pb-7 lg:pb-6">
              ...
              <div className="text-xs text-gray-700 text-center mt-2 sm:mt-4">
                        ...
                        return (
                          <label key={period} className={`relative ${isDisabled ? 'cursor-not-allowed opacity-50' : 'cursor-pointer'}`}>
                            ...
                            {period === '10년' && !isDisabled && (
                              <span className="absolute -top-3 left-1/2 -translate-x-1/2 bg-gradient-to-r from-[#fb923c] to-[#f97316] text-white text-xs font-bold px-2.5 py-0.5 rounded-full shadow-lg z-10 animate-bounce">추천</span>
                            )}
                            <input
                              type="radio"
                              name="paymentPeriod"
                            ...
                            <div className={`w-full text-center py-2 sm:py-2.5 text-xs sm:text-sm border-2 rounded-lg transition-all ${isDisabled
                              ...
                              : 'peer-checked:border-[#f59e0b] peer-checked:bg-[#f59e0b]/5 peer-checked:text-[#f59e0b] peer-checked:font-bold hover:border-[#f59e0b]/50 border-gray-200'
                              }`}>
                              {period}
                            </div>
                          </label>
                    ...
                    <div className="grid grid-cols-3 gap-1.5 sm:gap-2">
                      {['30만원', '50만원', '70만원', '100만원', '130만원', '150만원'].map((amount) => (
                        <label key={amount} className="relative flex items-center justify-center cursor-pointer">
                          ...
                          />
                          <div className="w-full text-center py-2 sm:py-2.5 text-xs sm:text-sm border-2 rounded-lg cursor-pointer transition-all peer-checked:border-[#f59e0b] peer-checked:bg-[#f59e0b]/5 peer-checked:text-[#f59e0b] peer-checked:font-bold hover:border-[#f59e0b] hover:bg-gray-50 border-gray-200">
                            {amount}
                          </div>
                        </label>
                      ))}
