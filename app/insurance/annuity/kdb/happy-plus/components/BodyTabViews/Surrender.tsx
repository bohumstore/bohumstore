  ...
  return (
    <div className="space-y-8 px-2 py-4 sm:px-4 md:px-8 md:py-6">
      ...
      <div className="space-y-4">
        ...
        <div className="product-info-box">
          <p className="product-text">
            계약자께서는 보험계약을 청약할 때 보험상품명, 보험기간, 보험료, 보험료납입기간, 피보험자
            등을 반드시 확인하시기 바랍니다.
          </p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="product-info-box">
          <p className="product-text">
            당사 및 모집종사자는 해당 상품에 대해 충분히 설명할 의무가 있으며, 계약자는 가입에 앞서
      ...
      <div className="space-y-4">
        ...
        <div className="product-info-box">
          <p className="product-text">
            청약시 청약서 자필서명란에는 반드시 계약자와 피보험자 본인이 직접 서명하셔야만 보험금
            지급이 보장됩니다.
          </p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="product-info-box">
          <p className="product-text">
            피보험자의 건강상태, 직업 등 청약서에서 질문한 사항에 대하여 사실대로 알려야 합니다.
            그렇지 않은 경우 보험금 지급이 거절되거나 계약이 해지될 수 있으며, 계약이 해지 된 경우
            해약환급금을 지급합니다.
          </p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="product-info-box">
          <p className="product-text">
            보험계약자는 보험증권을 받은 날부터 15일 이내(청약을 한 날부터 30일 이내(65세 이상
            계약자가 전화를 이용하여 계약을 체결한 경우 청약을 한 날부터 45일 이내)에 한함)에 청약을
            철회할 수 있으며, 이 경우 철회를 접수한 날부터 3영업일 이내에 보험료를 돌려 드립니다.
            단, 회사가 건강상태 진단을 지원하는 계약, 보험기간이 90일 이내인 계약 또는
            전문금융소비자가 체결한 계약은 청약을 철회할 수 없습니다. 청약철회 기간내에 청약철회를
      ...
      <div className="space-y-4">
        ...
        <div className="product-info-box">
          <p className="product-text">
            보험계약을 체결할 때 청약서에 자필서명(전자서명 포함)을 하지 않았거나 청약할 때 약관과
            계약자 보관용 청약서를 전달받지 못한 경우 또는 약관의 중요한 내용을 설명받지 못한
            경우에는 계약자는 계약이 성립한 날부터 3개월 이내에 계약을 취소할 수 있으며, 납입한
            보험료 전액과 정해진 이자를 지급합니다.
          </p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="product-info-box">
          <p className="product-text">
            기존에 체결했던 계약을 해지하고 다른 계약을 체결하는 경우에는 계약체결의 거부 또는
            보험료 등 금융소비자의 지급비용이 인상되거나 보장내용이 변경될 수 있습니다.
          </p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="product-info-box">
          <p className="product-text">
            보험은 은행의 저축과는 달리 위험보장과 저축을 겸하는 제도로서, 계약자가 납입한 보험료 중
            일부는 불의의 사고를 당한 다른 가입자에게 보험금으로 지급되며, 또 다른 일부는 보험회사의
            운영에 필요한 경비로 사용되므로 중도 해지시 지급되는 해약환급금은 납입한 보험료보다
            적거나 없을 수도 있습니다.
          </p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="product-info-box">
          <p className="product-text">
            본 안내는 법령 및 내부통제기준에 따른 광고관련 절차를 준수하여 제작되었습니다.
          </p>
        </div>
      </div>
