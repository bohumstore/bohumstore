      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
          <div className="space-y-2">
            <p className="text-gray-700">※ 이 보험계약은 예금자보호법에 따라 해약환급금(또는 만기 시 보험금)에 기타지급금을 합한 금액이 1인당 5천만원까지(본 보험회사의 여타 보호상품과 합산) 보호됩니다.</p>
            <p className="text-gray-700">이와 별도로 본 보험회사의 보호상품의 사고보험금을 합산한 금액이 1인당 5천만원까지 보호됩니다.</p>
            <p className="text-red-600">단, 2025년 9월 1일부터 해당 보호 한도가 1억원으로 상향됩니다.</p>
