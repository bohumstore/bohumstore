  ...
  return (
    <ProductInfoBodyTabTemplate title="가입안내">
      ...
      <div className="space-y-4">
        <h3 className="product-section-title">기본정보</h3>
              ...
              <table className="product-table">
                <tbody className="text-text-primary">
                  <tr>
                    ...
                    <td className="product-table-td">종신</td>
                    <td className="product-table-td w-[100px] font-bold sm:w-[140px] md:w-[180px]">
                      납입주기
                    </td>
                  ...
                  <tr>
                    <td className="product-table-td font-bold">
                      납입기간
                    </td>
                    <td className="product-table-td" colSpan={3}>
                      5년납 / 7년납 / 10년납 / 15년납 / 20년납
                    </td>
                  </tr>
                  <tr>
                    <td className="product-table-td font-bold">
      ...
      <div className="space-y-4">
        <h3 className="product-section-title">가입연령</h3>
        <div className="product-info-box">
          <div className="space-y-4">
            <div className="overflow-x-auto">
              <table className="product-table">
                <thead>
                  <tr className="product-table-header">
                    <th className="product-table-th" rowSpan={2} colSpan={3}>
                      유형
                    </th>
                ...
                <tbody className="text-text-primary">
                  ...
                  <tr>
                    <td className="product-table-td-center" rowSpan={4}>
                      저해약환급
                      <br className="sm:hidden" />
                      금형Ⅱ
                    </td>
            ...
            <div className="text-sm text-status-red">
              * 가입나이 및 가입한도 등의 계약인수 관련 사항은 회사가 정한 기준에 따라 제한될 수
              있습니다.
            </div>
          </div>
        </div>
      ...
      <div className="space-y-4">
        <h3 className="product-section-title">유지보너스 안내</h3>
        <div className="product-info-box">
          <div className="space-y-4">
            <p className="text-base leading-relaxed">
              보험료 납입이 완료되고 유지보너스 발생일에 유효한 계약에 한하여 다음과 같이 계산한
              유지보너스를 계약자적립액에 가산합니다.
            </p>

            <div className="rounded-md border border-divider bg-white/50 p-3">
              <p className="font-semibold">
                * 유지보너스금액 : 주계약 기본보험료 × 12 × 보험료 납입기간(년수) × 유지보너스 지급률
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="space-y-4">
        <h3 className="product-section-title">유지보너스 발생일</h3>
        <div className="product-info-box">
          <div className="space-y-4">
            <p className="font-semibold">- 저해약환급금형Ⅰ</p>
            <div className="overflow-x-auto">
              <table className="product-table">
                <thead>
                  <tr className="product-table-header">
                ...
                <tbody className="text-text-primary">
                  <tr>
                    <td className="product-table-td-center">5년납</td>
                    <td className="product-table-td-center">
                      계약일로부터 5년 경과시점 월계약해당일,
                      <br />
                      계약일로부터 10년 경과시점 월계약해당일
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <p className="mt-4 font-semibold">- 저해약환급금형Ⅱ</p>
            <div className="overflow-x-auto">
              <table className="product-table">
                <thead>
                  <tr className="product-table-header">
      ...
      <div className="space-y-4">
        <h3 className="product-section-title">유지보너스 지급률</h3>
        <div className="product-info-box">
          <div className="space-y-4">
            <p className="font-semibold">- 저해약환급금형Ⅰ</p>
            <div className="overflow-x-auto">
            ...
            <div className="text-sm text-text-secondary">
              • 납입기간 내 중도 해지시 지급하는 해약환급금에는 유지보너스가 가산되지 않습니다.
            </div>
          </div>
        </div>
      </div>
