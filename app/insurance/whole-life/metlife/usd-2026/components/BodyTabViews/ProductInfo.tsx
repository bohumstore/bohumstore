          ...
          <table className="w-full border-collapse text-[10px] sm:text-xs md:text-sm">
            ...
            <tbody>
              <tr>
                ...
                <td className="border border-gray-300 p-1 sm:p-2 text-center">200.4</td>
                <td className="border border-gray-300 p-1 sm:p-2 text-center">195.2</td>
              </tr>
              <tr>
                <td className="border border-gray-300 p-1 sm:p-2 text-center">40세</td>
                <td className="border border-gray-300 p-1 sm:p-2 text-center">214.6</td>
                <td className="border border-gray-300 p-1 sm:p-2 text-center">209.1</td>
              </tr>
              <tr>
                <td className="border border-gray-300 p-1 sm:p-2 text-center">50세</td>
                <td className="border border-gray-300 p-1 sm:p-2 text-center">230.7</td>
                <td className="border border-gray-300 p-1 sm:p-2 text-center">224.4</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full border-collapse text-[10px] sm:text-xs md:text-sm">
            ...
            <tbody>
              <tr>
                <td className="border border-gray-300 p-1 sm:p-2 text-center">30세</td>
                <td className="border border-gray-300 p-1 sm:p-2 text-center">107.9</td>
                <td className="border border-gray-300 p-1 sm:p-2 text-center">105.1</td>
              </tr>
              <tr>
                <td className="border border-gray-300 p-1 sm:p-2 text-center">40세</td>
                <td className="border border-gray-300 p-1 sm:p-2 text-center">115.7</td>
                <td className="border border-gray-300 p-1 sm:p-2 text-center">112.6</td>
              </tr>
              <tr>
                <td className="border border-gray-300 p-1 sm:p-2 text-center">50세</td>
                <td className="border border-gray-300 p-1 sm:p-2 text-center">124.5</td>
                <td className="border border-gray-300 p-1 sm:p-2 text-center">121.0</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full border-collapse text-xs sm:text-sm">
            ...
            <tbody>
              <tr>
                <td className="border border-gray-300 p-2 text-center">5년납</td>
                <td className="border border-gray-300 p-2 text-center">5년경과 22.5% / 10년경과 11.0%</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full border-collapse text-xs sm:text-sm">
            ...
            <tbody>
              <tr>
                <td className="border border-gray-300 p-2 text-center">7년납</td>
                <td className="border border-gray-300 p-2 text-center">7년경과 22.2% / 10년경과 15.9%</td>
              </tr>
              <tr>
                <td className="border border-gray-300 p-2 text-center">10년납</td>
                <td className="border border-gray-300 p-2 text-center">10년경과 39.7%</td>
              </tr>
              <tr>
                <td className="border border-gray-300 p-2 text-center">15년납</td>
                <td className="border border-gray-300 p-2 text-center">15년경과 39.7%</td>
              </tr>
              <tr>
                <td className="border border-gray-300 p-2 text-center">20년납</td>
                <td className="border border-gray-300 p-2 text-center">20년경과 39.7%</td>
              </tr>
            </tbody>
          </table>
        </div>
