    ...
    <Modal title="가입시 알아두실 사항" open={open} onClose={onClose}>
      <div className="overflow-y-auto px-6 py-4 text-[15px] leading-relaxed" style={{maxHeight:'60vh'}}>
        ...
        <div className="mb-4">
          ...
          <div className="mb-2">• 이 자료는 요약된 것으로, 가입 전에 해당 상품의 약관 및 상품설명서를 자세히 확인하시기 바랍니다.</div>
          <div className="mb-2">• 기존 보험계약 해지 후 신규 계약 체결 시 인수 거절, 보험료 인상, 보장 제한 등 불이익이 발생할 수 있습니다.</div>
          <div className="mb-2">• 청약 시에는 주계약·특약별 주요내용(상품명, 가입금액, 보험기간, 보험료, 납입기간, 보장범위, 면책사유 및 기간 등)을 반드시 확인해 주세요.</div>
          <div className="mb-2">• 계약심사 및 관리단계에서 추가 절차(적부, 진단, 실효안내 등)가 진행될 수 있으며, 절차 이행이 불가한 경우 가입이 제한될 수 있습니다.</div>
          <div className="mb-2">• 민원 및 분쟁은 금융감독원(1332), 1372소비자상담센터(1372) 등을 통해 도움을 받으실 수 있습니다.</div>
          <div className="mb-2">• 보험사기(고의사고, 허위사고 등)는 관련 법령에 의해 처벌됩니다.</div>
          <div className="mb-2">• 보험가입 내역 조회는 생명보험협회/손해보험협회를 통해 가능합니다.</div>
        </div>
        ...
        <div className="mb-4">
          ...
          <div className="mb-3">
            ...
            <div>• 자세한 사항은 보험회사 대표 홈페이지의 소비자 권리사항 안내를 참고하시기 바랍니다.</div>
          </div>
        </div>
