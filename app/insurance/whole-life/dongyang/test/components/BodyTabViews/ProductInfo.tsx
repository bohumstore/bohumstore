  ...
  return (
    <div className="space-y-8 px-2 sm:px-4 md:px-8 py-4 md:py-6">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-page-bg p-6 rounded-lg border border-border-default">
          <div className="space-y-4">
            <div className="flex flex-col md:flex-row md:items-center border-b border-border-default pb-4 hover:cursor-pointer">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-page-bg p-6 rounded-lg border border-border-default">
          <div className="space-y-6">
            <div className="flex flex-col md:flex-row border-b border-border-default pb-4 hover:cursor-pointer">
      ...
      <div className="space-y-4">
          ...
          <table className="w-full border-collapse min-w-[600px]">
            <thead>
              <tr className="bg-[#1e3a8a] text-white hover:cursor-pointer">
                <th className="border border-border-default p-3">보험료납입기간</th>
                <th className="border border-border-default p-3">최소거치기간</th>
                <th className="border border-border-default p-3">가입나이</th>
              </tr>
            </thead>
            <tbody>
              <tr className="hover:cursor-pointer">
                <td className="border border-border-default p-3 text-center">5년납</td>
                <td className="border border-border-default p-3 text-center">10년</td>
                <td className="border border-border-default p-3 text-center" rowSpan={3}>
                  0세 ~ MIN [연금개시나이- 15, 70] 세
                </td>
              </tr>
              <tr className="hover:cursor-pointer">
                <td className="border border-border-default p-3 text-center">7년납</td>
                <td className="border border-border-default p-3 text-center">8년</td>
              </tr>
              <tr className="hover:cursor-pointer">
                <td className="border border-border-default p-3 text-center">10년납</td>
                <td className="border border-border-default p-3 text-center">5년</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="block md:hidden space-y-2">
          {/* 예시: 보험료 납입기간, 최소거치기간 및 가입나이 표 */}
          {/* 실제 데이터 매핑 필요, 아래는 구조 예시 */}
          {/* {data.map((row, i) => (
            <div key={i} className="border rounded p-2 bg-white">
              <div><b>보험료납입기간:</b> {row.period}</div>
              <div><b>최소거치기간:</b> {row.waiting}</div>
              <div><b>가입나이:</b> {row.age}</div>
            </div>
          ))} */}
        </div>
        <p className="text-sm text-text-secondary">※ 최소거치기간 : 보험료 납입완료후 연금지급개시시점까지의 최소기간</p>
      </div>
      ...
      <div className="space-y-6">
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="bg-[#1e3a8a] text-white hover:cursor-pointer">
                <th className="border border-border-default p-3">보험료납입기간</th>
                <th className="border border-border-default p-3">가입나이</th>
                <th className="border border-border-default p-3">최소보험료(1구좌당)</th>
                <th className="border border-border-default p-3">최대보험료(1구좌당)</th>
              </tr>
            </thead>
            <tbody>
              <tr className="hover:cursor-pointer">
                <td className="border border-border-default p-3 text-center">5년납</td>
                <td className="border border-border-default p-3 text-center">0세 ~ 70세</td>
                <td className="border border-border-default p-3 text-center">30만원</td>
                <td className="border border-border-default p-3 text-center" rowSpan={3}>100만원</td>
              </tr>
              <tr className="hover:cursor-pointer">
                <td className="border border-border-default p-3 text-center">7년납</td>
                <td className="border border-border-default p-3 text-center">0세 ~ 70세</td>
                <td className="border border-border-default p-3 text-center">20만원</td>
              </tr>
              <tr className="hover:cursor-pointer">
                <td className="border border-border-default p-3 text-center">10년납</td>
                <td className="border border-border-default p-3 text-center">0세 ~ 70세</td>
                <td className="border border-border-default p-3 text-center">10만원</td>
              </tr>
            </tbody>
          </table>
          <p className="text-sm text-text-secondary">※ 구좌란 보험금과 보장내용 등을 관리하기 위한 계약의 단위를 의미하며, 구좌당 최소ㆍ최대 보험료 등은 보험 상품마다 차이가 있으므로 자세한 내용은 약관을 참고해 주시길 바랍니다.</p>
        </div>

        {/* 추가납입보험료 */}
        <div className="space-y-4">
          <h4 className="text-lg font-bold text-[#1e3a8a] border-b border-[#1e3a8a] pb-2 hover:cursor-pointer">추가납입보험료</h4>
          <div className="bg-page-bg p-6 rounded-lg border border-border-default space-y-4">
          ...
          <div className="bg-bg-blue p-6 rounded-lg space-y-3">
            <div className="text-status-red">[보험료 추가납입제도 안내]</div>
            <div className="text-status-red space-y-2">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-page-bg p-6 rounded-lg border border-border-default space-y-4">
            ...
            <p className="text-status-red">(6) 연금계약 계약자적립액 인출 시 인출금액 및 인출금액에 적립되는 이자만큼 연금계약 계약자적립액에서 차감하여 지급하므로 연금액 및 해약환급금이 감소할 수 있습니다.</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-page-bg p-6 rounded-lg border border-border-default">
          ...
          <div className="bg-bg-blue p-6 rounded-lg">
            <div className="text-center font-bold mb-4 text-[#1e3a8a]">트리플 레벨업 보증금액 = 트리플 레벨업 보증 기준금액 X 트리플 레벨업 보증비율</div>
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-[#1e3a8a] text-white hover:cursor-pointer">
                  <th className="border border-border-default p-3">트리플 레벨업<br />보증시점</th>
                  <th className="border border-border-default p-3">트리플 레벨업<br />보증 기준금액</th>
                  <th className="border border-border-default p-3" colSpan={3}>트리플 레벨업 보증비율</th>
                </tr>
                <tr className="bg-[#1e3a8a] text-white hover:cursor-pointer">
                  <th className="border border-border-default p-3" colSpan={2}></th>
                  <th className="border border-border-default p-3">5년납</th>
                  <th className="border border-border-default p-3">7년납</th>
                  <th className="border border-border-default p-3">10년납</th>
                </tr>
              </thead>
              <tbody>
                <tr className="hover:cursor-pointer">
                  <td className="border border-border-default p-3">계약일부터 7년<br />경과시점의 연계약해당일</td>
                  <td className="border border-border-default p-3" rowSpan={2}>보증시점 전일까지의<br />"기초 기본보험료"</td>
                  <td className="border border-border-default p-3 text-center">100%</td>
                  <td className="border border-border-default p-3 text-center">100%</td>
                  <td className="border border-border-default p-3 text-center">100%</td>
                </tr>
                <tr className="hover:cursor-pointer">
                  <td className="border border-border-default p-3">계약일부터 10년<br />경과시점의 연계약해당일</td>
                  <td className="border border-border-default p-3 text-center">130%</td>
                  <td className="border border-border-default p-3 text-center">125%</td>
                  <td className="border border-border-default p-3 text-center">120%</td>
                </tr>
                <tr className="hover:cursor-pointer">
                  <td className="border border-border-default p-3">연금개시시점</td>
                  <td className="border border-border-default p-3 text-center" colSpan={4}>
          ...
          <div className="mt-4 space-y-2 text-sm">
            ...
            <p className="text-status-red">※ 트리플 레벨업 보증 기준금액은 감액 또는 중도인출이 발생한 경우 기본보험료 계약자적립액에 비례하여 감소하며, 중도인출금액을 재납입하더라도 원복되지 않습니다.</p>
            <p className="text-status-red">※ 연금개시시점의 트리플 레벨업 보증은 연금을 개시할 경우에만 적용되며, 연금을 개시하지 않을 경우 보증되지 않습니다.</p>
          </div>
        </div>
      </div>
