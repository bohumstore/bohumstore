  ...
  <div className="space-y-8 px-2 sm:px-4 md:px-8 py-4 md:py-6">
    ...
    <div className="space-y-4">
      ...
      <div className="flex justify-end mb-1">
        <p className="product-caption">기준: 남자 40세, 일반심사형, 보험료형, 종신, 5년납, 월납, 30만원 (단위: 원)</p>
      </div>
      <div className="overflow-x-auto">
        <table className="product-table">
          ...
          <tbody className="product-table-body">
            <tr>
              <td className="product-table-td-center" rowSpan={3}>사망보험금</td>
              <td className="product-table-td-center" rowSpan={3}>보험기간 중 피보험자가 사망하였을 때</td>
              <td className="product-table-td-center leading-tight sm:leading-relaxed">기본보험료 납입중<br />: (기준사망보험금, 이미 납입한 보험료) 중 큰 금액</td>
            </tr>
            <tr>
              <td className="product-table-td-center leading-tight sm:leading-relaxed">기본보험료 총액을 납입하고 보험료 납입기간 이후<br />: (기준사망보험금, 계약자적립액의 101%, 이미 납입한 보험료) 중 가장 큰 금액</td>
            </tr>
            <tr>
              <td className="product-table-td-center leading-tight sm:leading-relaxed">※ 기준사망보험금<br />
