  ...
  <div className="space-y-8 px-2 sm:px-4 md:px-8 py-4 md:py-6">
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-1.5 text-xs sm:text-sm text-gray-600 mt-4">
        ...
        <p>2. 보험료 납입기간 중 피보험자가 「약관 장해분류표(&lt;부표4&gt; 참조) 중 동일한 재해 또는 재해이외의 동일한 원인으로 여러 신체부위의 장해지급률을 더하여 50%이상인 장해상태」가 되었을 경우에는 차회 이후의 기본보험료 납입을 면제합니다. 또한, 기본보험료의 납입이 면제된 경우 차회 이후부터 보험료 납입기간 종료일까지 매월 월계약해당일에 정상적으로 기본보험료가 납입된 것으로 보고 계약자적립액을 계산합니다.</p>
        ...
        <p>7. {'\'5.\''} 및 {'\'6.\''} 의 "보너스 발생일"이라 함은 약관 제2조의3("보너스"에 관한 사항)에서 정한 보너스 발생일을 말하며, 각각의 "보너스 발생일"에 보험료 납입을 연체한 경우에는 연체보험료[기본보험료 총액을 납입하고 보험료 납입기간이 완료된 이후에 해약환급금(다만, 보험계약대출의 원금과 이자를 차감한 금액으로 특약의 해약환급금은 제외된 금액)에서 월대체보험료를 충당할 수 없게 된 경우에는 연체된 월대체보험료 이상의 금액] 납입일을 각각의 "보너스 발생일"로 합니다.</p>
        <br />
