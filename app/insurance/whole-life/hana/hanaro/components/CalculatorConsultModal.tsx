          ...
          <CustomSelect
            ...
            options={['5년납', '7년납', '10년납'].map(p => {
              ...
              return {
                value: p,
                disabled: isDisabled,
                label: isDisabled ? `${p} (가입불가)` : p === '5년납' ? (
                  <span className="flex items-center gap-1">
                    5년납 <span className="px-1.5 py-0.5 rounded text-[10px] font-bold bg-brand-primary-soft text-brand-primary leading-none">추천</span>
                  </span>
                ) : p
              };
            })}
