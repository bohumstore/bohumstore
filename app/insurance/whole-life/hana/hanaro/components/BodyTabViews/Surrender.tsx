  ...
  return (
    <div className="space-y-8 px-2 sm:px-4 md:px-8 py-4 md:py-6">
      <div className="mb-2">
        ...
        <p className="product-text mt-4 mb-6">
        ...
        <table className="product-table text-center">
          <thead>
            ...
            <tr className="product-table-header">
              <th className="product-table-th">사망<br className="md:hidden" />보험금</th>
              <th className="product-table-th">납입<br className="md:hidden" />보험료</th>
              <th className="product-table-th">해약<br className="md:hidden" />환급금</th>
      ...
      <div className="space-y-4 mt-8">
        ...
        {/* 비교표 */}
        <div className="mt-6">
          <h4 className="product-small-title text-center mb-4 text-[#1e3a8a]">간편심사형 VS 일반심사형 비교</h4>
          ...
          <div className="overflow-x-auto">
            <table className="product-table">
              ...
              <tbody className="product-table-body">
                <tr>
                  <td className="product-table-td-center font-semibold bg-page-bg">보장내용</td>
                  <td className="product-table-td-center">'보험금 지급기준' 참고</td>
                  <td className="product-table-td-center">'보험금 지급기준' 참고</td>
                </tr>
                <tr>
                  <td className="product-table-td-center font-semibold bg-page-bg">계약승낙여부</td>
                  <td className="product-table-td-center">일반상품 대비 질문항목을 간소화하여,<br/>지병이나 기왕력이 있어도 가입 가능</td>
                  <td className="product-table-td-center">피보험자의 건강상태 및 작업에 따라서<br/>청약에 대한 승낙을 거절 가능</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="mt-6 space-y-3 text-sm">
          <p className="font-semibold text-text-primary">*아래 3가지 질문을 통과하면 유병력자도 2형(간편심사형) 가입이 가능합니다.</p>
          
          <div className="space-y-4 pl-4">
            <div>
              <p className="font-semibold mb-2 text-text-primary">1. 최근 3개월 이내에 의사로부터 진찰 또는 검사(건강검진 포함)를 통하여 다음과 같은 의료행위를 받은 사실이 있습니까? (예, 아니오)</p>
              <div className="pl-4 space-y-1 text-text-primary">
                <p>1) 입원 필요 소견</p>
                <p>2) 수술 필요 소견</p>
            ...
            <div>
              <p className="font-semibold mb-2 text-text-primary">2. 최근 2년 이내에 질병이나 사고로 인하여 다음과 같은 의료행위를 받은 사실이 있습니까? (예, 아니오)</p>
              <div className="pl-4 space-y-1 text-text-primary">
                <p>1) 입원</p>
                <p>2) 수술(제왕절개 포함)</p>
              </div>
            ...
            <div>
              <p className="font-semibold mb-2 text-text-primary">3. 최근 5년 이내에 의사로부터 진찰 또는 검사를 통하여 암으로 "진단"받거나 암으로 "입원 또는 수술"을 받은 적이 있습니까? (예, 아니오)</p>
              <p className="pl-4 text-xs text-text-primary">*암: 악성신생물, 백혈병 및 기타 혈액종양 포함</p>
            </div>
          </div>
        </div>
      </div>
