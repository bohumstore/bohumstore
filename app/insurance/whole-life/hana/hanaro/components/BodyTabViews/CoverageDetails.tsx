  ...
  <div className="space-y-8 px-2 sm:px-4 md:px-8 py-4 md:py-6">
    ...
    <div className="space-y-4">
      ...
      <div className="overflow-x-auto">
        <table className="product-table">
          ...
          <tbody className="product-table-body">
            <tr>
              <td className="product-table-td-center font-semibold" rowSpan={3}>사망보험금</td>
              <td className="product-table-td-center" rowSpan={3}>피보험자가 보험기간중 사망하였을 때</td>
              <td className="product-table-td-center">계약일~<br/>계약일부터 1년경과시점 계약해당일 전일까지</td>
              <td className="product-table-td-center">5,000만원</td>
            </tr>
            <tr>
              <td className="product-table-td-center">계약일부터 1년경과시점 계약해당일~<br/>계약일부터 11년경과시점 계약해당일 전일까지</td>
              <td className="product-table-td-center">보험가입금액에 계약일로부터 1년이 지난<br/>계약해당일부터 매1년마다 '보험가입금액의 5%'를 더한 금액</td>
            </tr>
            <tr>
              <td className="product-table-td-center">계약일부터 11년경과시점 계약해당일~<br/>종신까지</td>
      ...
      <div className="mt-6">
        ...
        <p className="product-caption text-right mb-2">기준: 가입나이 40세, 보험가입금액 5천만원</p>
    ...
    <div className="space-y-4 mt-8">
      ...
      <div className="overflow-x-auto">
        <table className="product-table">
          ...
          <tbody className="product-table-body">
            <tr>
              <td className="product-table-td-center font-semibold">3대질병진단<br/>보험료환급금</td>
              <td className="product-table-td">
                ...
                <p className="product-caption mt-1">(계약일부터 1년미만 진단확정시 50%지급, 최초 1회한함)</p>
              </td>
              <td className="product-table-td-center">보험료환급<br/>대상계약의 총보험료</td>
            </tr>
          </tbody>
        </table>
      </div>
    ...
    <div className="space-y-4 mt-8">
      ...
      <div className="product-info-box">
        ...
        <p className="product-caption mt-2">* 암보장개시일: 계약일(부활(효력회복)일)부터 그 날을 포함하여 90일이 지난날의 다음날</p>
      </div>
    </div>
  </div>
  )
