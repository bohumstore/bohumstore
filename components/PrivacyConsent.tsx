...
export default function PrivacyConsent() {
  return (
    ...
    >
      <div className="mb-4 text-lg font-bold">[개인 정보 수집 및 이용 동의]</div>
      <div className="mb-4">
        ㈜ 메타리치 보험스토어는 상담신청 및 보험상품 소개를 위해 고객님의 개인정보 수집, 이용 및
        제공에 대한 동의를 받고 있습니다.
      </div>
      <div className="mb-2 font-bold">▣ 개인정보 수집ㆍ이용 동의</div>
      <div className="mb-2">
        당사 및 당사 업무수탁자는 「개인정보보호법」, 「정보통신망 이용촉진 및 정보 보호 등에 관한
        법률」에 따라 귀하의 개인정보를 다음과 같이 수집·이용하고자 합니다.
      </div>
      ...
      <div className="mb-2">
        ...
        <br />- 동의 거부시 보험계약 상담 등의 서비스를 받으실 수 없습니다.
      </div>
      ...
      <div className="mb-2">
        - 귀하는 개인정보 수집, 이용에 대한 동의를 거부할 권리가 있습니다.
        <br />- 동의 거부 시 보험계약 상담 등의 서비스를 받으실 수 없습니다.
      </div>
      <div className="mb-2 font-bold">▣ 개인정보 활용에 관한 동의</div>
      <div className="mb-2">
        ㈜메타리치 보험스토어는 「개인정보보호법」및「신용정보의 이용 및 보호에 관한 법률」에 따라
        당사 상품소개 및 홍보 등을 위하여 귀하의 개인(신용)정보를 다음과 같이 수집ㆍ이용하고자
        합니다.
      </div>
      ...
      <div className="mb-2">
        상담신청에 대한 응대, 우편 · 전화 · 인터넷 · 방문 등을 통한 유익한 정보의 제공, 금융상품
        소개 및 가입 권유, 재무설계서비스 및 기타 서비스의 제공 안내, 이벤트 · 행사의 안내 등 회사의
        정상적인 영업에 관계된 행위
      </div>
      <div className="mb-2">
      ...
      <div>
        본 동의를 하시더라도 당사 고객센터를 통해 동의를 철회하거나 가입 권유 목적의 연락에 대한
        중단을 요청하실 수 있습니다.
      </div>
    </div>
  );
