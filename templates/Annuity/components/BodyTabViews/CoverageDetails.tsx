  ...
  return (
    <div className="space-y-8 px-2 py-4 sm:px-4 md:px-8 md:py-6">
      ...
      <div className="space-y-4">
            ...
            <tbody>
              <tr className="hover:cursor-pointer">
                ...
                <td className="border border-gray-300 p-3 text-center">
                  매월 <span className="font-bold text-[#1e3a8a]">40</span>만원(36회 지급)
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <div className="space-y-2 text-sm text-gray-600">
          ...
          <p>
            ...
            계약자적립액과 이미 납입한 보험료(연금계약 계약자적립액 인출 시 차감하고 계산) 중 큰
            금액을 지급하여 드립니다.
          </p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2 text-sm text-gray-600">
          <p>
            주1) "생활설계자금 선택비율"이란 생활설계자금의 인출을 위해 계약자가 회사가 정하는 비율
            ...
            산출방법서에 따라 연금액이 산출합니다. 다만, 기본보험료를 5년(60회)이상 납입하지 않은
            경우에는 "생활설계자금 선택비율"을 0%로 합니다.
          </p>
          <p>
            주2) 종신연금형의 경우 연금지급개시 후 보증지급기간 안에 피보험자가 사망하더라도
            보증지급기간까지의 미지급된 각 연금액을 연금지급일에 드립니다.
          </p>
          <p>
            주3) 종신연금형(100세 보증)은 "100세-연금개시나이"를 보증기간 연금액에서 보증지급합니다.
          </p>
          <p>
            주4) 확정연금형으로 변경한 경우 연금개시시 후 해당 확정 연금지급기간(5년, 10년, 15년,
            20년) 동안에 피보험자가 사망하더라도 각 확정 연금지급기간(5년, 10년, 15년, 20년)까지의
            지급되지 않은 각 연금액을 연금지급일에 드립니다.
          </p>
          <p>
          ...
          <p>
            ...
            않은 경우에는 연금지급형태 중 종신연금형을 선택한 경우, 확정연금형 또는 상속연금형은
            종신연금형과 동시에 선택할 수 없습니다.
          </p>
          <p>
          ...
          <p>
            주10) 상속연금형의 "계약자적립액"이란 연금개시시점의 연금계약 계약자적립액에
            "공시이율"로 적립한 금액에서 상속연금형의 연금액 발생분(납입후 계약관리비용 포함)을 뺀
            나머지 금액을 공시이율로 적립한 금액으로 "보험료 및 해약환급금 산출방법서"에 정한 바에
            따라 계산됩니다.
          </p>
