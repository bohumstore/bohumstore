  ...
  return (
    <div className="space-y-8 px-2 py-4 sm:px-4 md:px-8 md:py-6">
      ...
      <div className="space-y-4">
        <h3 className="border-l-4 border-[#1e3a8a] pl-3 text-xl font-bold hover:cursor-pointer">
          상품 구성
        </h3>
        <div className="rounded-lg border border-gray-200 bg-gray-50 p-6">
          <div className="space-y-4">
            <div className="flex flex-col border-b border-gray-200 pb-4 hover:cursor-pointer md:flex-row md:items-center">
              ...
              <div className="flex-1 space-y-1">
                ...
                <div className="hover:cursor-pointer">
                  KB 트리플 레벨업 연금보험 무배당(미보증형)
                </div>
              </div>
            </div>
            <div className="flex flex-col hover:cursor-pointer md:flex-row md:items-center">
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-lg border border-gray-200 bg-gray-50 p-6">
          <div className="space-y-6">
            <div className="flex flex-col border-b border-gray-200 pb-4 hover:cursor-pointer md:flex-row">
      ...
      <div className="space-y-6">
        ...
        {/* 기본보험료 */}
        <div className="space-y-4">
          <h4 className="border-b border-[#1e3a8a] pb-2 text-lg font-bold text-[#1e3a8a] hover:cursor-pointer">
            기본보험료
          </h4>
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-lg border border-gray-200 bg-gray-50 p-6">
          ...
          <div className="rounded-lg bg-blue-50 p-6">
            <div className="mb-4 text-center font-bold text-[#1e3a8a]">
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-[#1e3a8a] text-white hover:cursor-pointer">
                  ...
                  <th className="border border-gray-300 p-3" colSpan={3}>
                    트리플 레벨업 보증비율
                  </th>
                </tr>
                <tr className="bg-[#1e3a8a] text-white hover:cursor-pointer">
              ...
              <tbody>
                <tr className="hover:cursor-pointer">
                  ...
                  <td className="border border-gray-300 p-3" rowSpan={2}>
                    보증시점 전일까지의
                    <br />
                    "기초 기본보험료"
                  </td>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-4 rounded-lg border border-gray-200 bg-gray-50 p-6">
          <p>
            ...
            트리플 레벨업 보증금액을 기본보험료 계약자적립액의 최저한도로 하여 연금계약
            계약자적립액을 구합니다.
          </p>
          <p>
